...
%files oracle-module
%ifarch i386
/usr/lib/qore-0.6.1/auto/oracle.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.6.1/auto/oracle.qmod
%endif
...
%files mysql-module
%ifarch i386
/usr/lib/qore-0.6.1/auto/mysql.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.6.1/auto/mysql.qmod
%endif
...
%files tibrv-module
%ifarch i386
/usr/lib/qore-0.6.1/tibrv.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.6.1/tibrv.qmod
%endif
...
%files tuxedo-module
%ifarch i386
/usr/lib/qore-0.6.1/tuxedo.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.6.1/tuxedo.qmod
%endif
...
%ifarch i386
mkdir -p $RPM_BUILD_ROOT/usr/lib/qore-0.6.1
mkdir -p $RPM_BUILD_ROOT/usr/lib/qore-0.6.1/auto
%endif
%ifarch x86_64
mkdir -p $RPM_BUILD_ROOT/usr/lib64/qore-0.6.1
mkdir -p $RPM_BUILD_ROOT/usr/lib64/qore-0.6.1/auto
%endif
...
/usr/bin/qore
%ifarch i386
/usr/lib/libqore.so.1.1.0
/usr/lib/libqore.so.1
/usr/lib/libqore.so
/usr/lib/libqore.la
/usr/lib/qore-0.6.1/ncurses.qmod
%endif
%ifarch x86_64
/usr/lib64/libqore.so.1.1.0
/usr/lib64/libqore.so.1
/usr/lib64/libqore.so
/usr/lib64/libqore.la
/usr/lib64/qore-0.6.1/ncurses.qmod
%endif
