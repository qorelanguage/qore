...
#ifdef S_ISUID
   ns->addConstant("S_ISUID", new QoreBigIntNode(S_ISUID));
#endif
#ifdef S_ISGID
   ns->addConstant("S_ISGID", new QoreBigIntNode(S_ISGID));
#endif
#ifdef S_ISVTX
   ns->addConstant("S_ISVTX", new QoreBigIntNode(S_ISVTX));
#endif
#ifdef S_ISTXT
   ns->addConstant("S_ISTXT", new QoreBigIntNode(S_ISTXT));
#endif
#ifdef S_IEXEC
