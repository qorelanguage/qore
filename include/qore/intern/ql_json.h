...
DLLEXPORT class QoreString *makeJSONRPC11RequestStringArgs(const QoreNode *params, ExceptionSink *xsink);
DLLEXPORT class QoreString *makeJSONRPC11RequestString(const QoreNode *params, ExceptionSink *xsink);
