...
#define QORE_MODULE_API_MINOR 13 //!< the minor number of the Qore module API implemented

#define QORE_MODULE_COMPAT_API_MAJOR 0  //!< the major number of the earliest recommended Qore module API
#define QORE_MODULE_COMPAT_API_MINOR 13 //!< the minor number of the earliest recommended Qore module API 
