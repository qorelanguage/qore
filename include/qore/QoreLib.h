...
DLLEXPORT class QoreStringNode *q_sprintf(const class QoreList *params, int field, int offset, class ExceptionSink *xsink);
DLLEXPORT class QoreStringNode *q_vsprintf(const class QoreList *params, int field, int offset, class ExceptionSink *xsink);
