...
typedef class QoreNode *(*q_method_t)(class QoreObject *, void *, class QoreNode *, class ExceptionSink *);
typedef void (*q_constructor_t)(class QoreObject *, class QoreNode *, class ExceptionSink *);
