...
typedef class QoreNode *(*q_func_t)(const class QoreListNode *args, class ExceptionSink *);
typedef class QoreNode *(*q_method_t)(class QoreObject *, void *, const class QoreListNode *args, class ExceptionSink *);
