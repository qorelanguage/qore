...
%files oracle-module
%ifarch i386
/usr/lib/qore-0.5.3/auto/oracle.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.5.3/auto/oracle.qmod
%endif
...
%files mysql-module
%ifarch i386
/usr/lib/qore-0.5.3/auto/mysql.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.5.3/auto/mysql.qmod
%endif
...
%files tibrv-module
%ifarch i386
/usr/lib/qore-0.5.3/tibrv.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.5.3/tibrv.qmod
%endif
...
%ifarch i386
mkdir -p $RPM_BUILD_ROOT/usr/lib/qore-0.5.3
mkdir -p $RPM_BUILD_ROOT/usr/lib/qore-0.5.3/auto
%endif
%ifarch x86_64
mkdir -p $RPM_BUILD_ROOT/usr/lib64/qore-0.5.3
mkdir -p $RPM_BUILD_ROOT/usr/lib64/qore-0.5.3/auto
%endif
...
/usr/lib/libqore.so
/usr/lib/libqore.la
/usr/lib/qore-0.5.3/ncurses.qmod
%endif
%ifarch x86_64
...
/usr/lib64/qore-0.5.3/ncurses.qmod
%endif
