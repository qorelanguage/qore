...
int BarewordNode::getAsString(QoreString &qstr, int foff, class ExceptionSink *xsink) const
{
...
QoreString *BarewordNode::getAsString(bool &del, int foff, class ExceptionSink *xsink) const
{
   del = true;
