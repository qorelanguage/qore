...
int ConstantNode::getAsString(QoreString &str, int foff, class ExceptionSink *xsink) const
{
...
QoreString *ConstantNode::getAsString(bool &del, int foff, class ExceptionSink *xsink) const
{
   del = true;
