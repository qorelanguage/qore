...
void init_thread_functions()
{
   ...
   builtinFunctions.add("get_thread_data", f_get_thread_data, FC_THREAD);
   builtinFunctions.add("get_all_thread_data", f_get_all_thread_data, FC_THREAD);
   builtinFunctions.add("save_thread_data", f_save_thread_data, FC_THREAD);
