...
static void DS_constructor(class QoreObject *self, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *DS_open(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)ds->open(xsink));
}

static QoreNode *DS_close(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)ds->close());
}

static QoreNode *DS_commit(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)ds->commit(xsink));
}

static QoreNode *DS_rollback(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)ds->rollback(xsink));
}

static QoreNode *DS_setAutoCommit(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *DS_getAutoCommit(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode(ds->getAutoCommit());
}

static QoreNode *DS_exec(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   class QoreStringNode *p0;
   if (!(p0 = test_string_param(params, 0)))
      return NULL;

   ReferenceHolder<QoreList> args((params->size() > 1 ? params->copyListFrom(1) : NULL), xsink);
   return ds->exec(p0, *args, xsink);
}

static QoreNode *DS_vexec(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   class QoreStringNode *p0;
   if (!(p0 = test_string_param(params, 0)))
      return NULL;
...
static QoreNode *DS_select(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p)
      return NULL;
...
static QoreNode *DS_selectRow(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p)
      return NULL;
...
static QoreNode *DS_selectRows(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p)
      return NULL;
...
static QoreNode *DS_vselect(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *DS_vselectRow(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p0 = test_string_param(params, 0);
   if (!p0)
      return NULL;
...
static QoreNode *DS_vselectRows(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p0 = test_string_param(params, 0);
   if (!p0)
      return NULL;
...
/*
static QoreNode *DS_describe(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *DS_beginTransaction(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   ds->beginTransaction(xsink);
   return NULL;
}

static QoreNode *DS_reset(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   ds->reset(xsink);
   return NULL;
}

static QoreNode *DS_getCapabilities(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)ds->getCapabilities());
}

static QoreNode *DS_getCapabilityList(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return ds->getCapabilityList();
}

static QoreNode *DS_setUserName(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p)
      return NULL;
...
static QoreNode *DS_setPassword(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p)
      return NULL;
...
static QoreNode *DS_setDBName(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p)
      return NULL;
...
static QoreNode *DS_setDBCharset(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p)
      return NULL;
...
static QoreNode *DS_setHostName(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p)
      return NULL;
...
static QoreNode *DS_getUserName(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return ds->getPendingUsername();
}

static QoreNode *DS_getPassword(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return ds->getPendingPassword();
}

static QoreNode *DS_getDBName(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return ds->getPendingDBName();
}

static QoreNode *DS_getDBCharset(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return ds->getPendingDBEncoding();
}

static QoreNode *DS_getOSCharset(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   const QoreEncoding *enc = ds->getQoreEncoding();
   return new QoreStringNode(enc ? enc->getCode() : "(unknown)");
}

static QoreNode *DS_getHostName(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return ds->getPendingHostName();
}

static QoreNode *DS_setTransactionLockTimeout(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   ds->setTransactionLockTimeout(getMsZeroInt(get_param(params, 0)));
   return NULL;
}

static QoreNode *DS_getTransactionLockTimeout(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)ds->getTransactionLockTimeout());
}

static QoreNode *DS_getDriverName(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreStringNode(ds->getDriver()->getName());
}

static QoreNode *DS_getServerVersion(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return ds->getServerVersion(xsink);
}

static QoreNode *DS_getClientVersion(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
   return ds->getClientVersion(xsink);
}

static QoreNode *DS_inTransaction(class QoreObject *self, class ManagedDatasource *ds, const QoreList *params, ExceptionSink *xsink)
{
