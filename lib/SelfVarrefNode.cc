...
int SelfVarrefNode::getAsString(QoreString &qstr, int foff, class ExceptionSink *xsink) const
{
...
QoreString *SelfVarrefNode::getAsString(bool &del, int foff, class ExceptionSink *xsink) const
{
   del = true;
...
class AbstractQoreNode *SelfVarrefNode::eval(class ExceptionSink *xsink) const
{
