...
static class QoreNode *RMUTEX_enter(class Object *self, class QoreRMutex *m, class QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)m->enter());
}

static class QoreNode *RMUTEX_tryEnter(class Object *self, class QoreRMutex *m, class QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)m->tryEnter()); 
}

static class QoreNode *RMUTEX_exit(class Object *self, class QoreRMutex *m, class QoreNode *params, ExceptionSink *xsink)
{
