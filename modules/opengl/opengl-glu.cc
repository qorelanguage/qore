...
void initOpenGLU()
{
   //builtinFunctions.add("gluBeginCurve",                f_gluBeginCurve);
   //builtinFunctions.add("gluBeginPolygon",              f_gluBeginPolygon);
   //builtinFunctions.add("gluBeginSurface",              f_gluBeginSurface);
   //builtinFunctions.add("gluBeginTrim",                 f_gluBeginTrim);
   //builtinFunctions.add("gluBuild1DMipmapLevels",       f_gluBuild1DMipmapLevels);
   //builtinFunctions.add("gluBuild1DMipmaps",            f_gluBuild1DMipmaps);
   //builtinFunctions.add("gluBuild2DMipmapLevels",       f_gluBuild2DMipmapLevels);
   //builtinFunctions.add("gluBuild2DMipmaps",            f_gluBuild2DMipmaps);
   //builtinFunctions.add("gluBuild3DMipmapLevels",       f_gluBuild3DMipmapLevels);
   //builtinFunctions.add("gluBuild3DMipmaps",            f_gluBuild3DMipmaps);
   //builtinFunctions.add("gluCheckExtension",            f_gluCheckExtension);
   //builtinFunctions.add("gluCylinder",                  f_gluCylinder);
   //builtinFunctions.add("gluDeleteNurbsRenderer",       f_gluDeleteNurbsRenderer);
   //builtinFunctions.add("gluDeleteQuadric",             f_gluDeleteQuadric);
   //builtinFunctions.add("gluDeleteTess",                f_gluDeleteTess);
   //builtinFunctions.add("gluDisk",                      f_gluDisk);
   //builtinFunctions.add("gluEndCurve",                  f_gluEndCurve);
   //builtinFunctions.add("gluEndPolygon",                f_gluEndPolygon);
   //builtinFunctions.add("gluEndSurface",                f_gluEndSurface);
   //builtinFunctions.add("gluEndTrim",                   f_gluEndTrim);
   builtinFunctions.add("gluErrorString",               f_gluErrorString);
   //builtinFunctions.add("gluGetNurbsProperty",          f_gluGetNurbsProperty);
   builtinFunctions.add("gluGetString",                 f_gluGetString);
   //builtinFunctions.add("gluGetTessProperty",           f_gluGetTessProperty);
   //builtinFunctions.add("gluLoadSamplingMatrices",      f_gluLoadSamplingMatrices);
   builtinFunctions.add("gluLookAt",                    f_gluLookAt);
   //builtinFunctions.add("gluNewNurbsRenderer",          f_gluNewNurbsRenderer);
   //builtinFunctions.add("gluNewQuadric",                f_gluNewQuadric);
   //builtinFunctions.add("gluNewTess",                   f_gluNewTess);
   //builtinFunctions.add("gluNextContour",               f_gluNextContour);
   //builtinFunctions.add("gluNurbsCallback",             f_gluNurbsCallback);
   //builtinFunctions.add("gluNurbsCallbackData",         f_gluNurbsCallbackData);
   //builtinFunctions.add("gluNurbsCallbackDataEXT",      f_gluNurbsCallbackDataEXT);
   //builtinFunctions.add("gluNurbsCurve",                f_gluNurbsCurve);
   //builtinFunctions.add("gluNurbsProperty",             f_gluNurbsProperty);
   //builtinFunctions.add("gluNurbsSurface",              f_gluNurbsSurface);
   builtinFunctions.add("gluOrtho2D",                   f_gluOrtho2D);
   //builtinFunctions.add("gluPartialDisk",               f_gluPartialDisk);
   builtinFunctions.add("gluPerspective",               f_gluPerspective);
   //builtinFunctions.add("gluPickMatrix",                f_gluPickMatrix);
   //builtinFunctions.add("gluProject",                   f_gluProject);
   //builtinFunctions.add("gluPwlCurve",                  f_gluPwlCurve);
   //builtinFunctions.add("gluQuadricCallback",           f_gluQuadricCallback);
   //builtinFunctions.add("gluQuadricDrawStyle",          f_gluQuadricDrawStyle);
   //builtinFunctions.add("gluQuadricNormals",            f_gluQuadricNormals);
   //builtinFunctions.add("gluQuadricOrientation",        f_gluQuadricOrientation);
   //builtinFunctions.add("gluQuadricTexture",            f_gluQuadricTexture);
   //builtinFunctions.add("gluScaleImage",                f_gluScaleImage);
   //builtinFunctions.add("gluSphere",                    f_gluSphere);
   //builtinFunctions.add("gluTessBeginContour",          f_gluTessBeginContour);
   //builtinFunctions.add("gluTessBeginPolygon",          f_gluTessBeginPolygon);
   //builtinFunctions.add("gluTessCallback",              f_gluTessCallback);
   //builtinFunctions.add("gluTessEndContour",            f_gluTessEndContour);
   //builtinFunctions.add("gluTessEndPolygon",            f_gluTessEndPolygon);
   //builtinFunctions.add("gluTessNormal",                f_gluTessNormal);
   //builtinFunctions.add("gluTessProperty",              f_gluTessProperty);
   //builtinFunctions.add("gluTessVertex",                f_gluTessVertex);
   //builtinFunctions.add("gluUnProject",                 f_gluUnProject);
   //builtinFunctions.add("gluUnProject4",                f_gluUnProject4);
}
