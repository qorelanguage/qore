...
void initOpenGLExt()
{
   builtinFunctions.add("glActiveTextureARB",           f_glActiveTextureARB);
   builtinFunctions.add("glClientActiveTextureARB",     f_glClientActiveTextureARB);
   builtinFunctions.add("glMultiTexCoord1dARB",         f_glMultiTexCoord1dARB);
   //builtinFunctions.add("glMultiTexCoord1dvARB",        f_glMultiTexCoord1dvARB);
   builtinFunctions.add("glMultiTexCoord1fARB",         f_glMultiTexCoord1fARB);
   //builtinFunctions.add("glMultiTexCoord1fvARB",        f_glMultiTexCoord1fvARB);
   builtinFunctions.add("glMultiTexCoord1iARB",         f_glMultiTexCoord1iARB);
   //builtinFunctions.add("glMultiTexCoord1ivARB",        f_glMultiTexCoord1ivARB);
   builtinFunctions.add("glMultiTexCoord1sARB",         f_glMultiTexCoord1sARB);
   //builtinFunctions.add("glMultiTexCoord1svARB",        f_glMultiTexCoord1svARB);
   builtinFunctions.add("glMultiTexCoord2dARB",         f_glMultiTexCoord2dARB);
   //builtinFunctions.add("glMultiTexCoord2dvARB",        f_glMultiTexCoord2dvARB);
   builtinFunctions.add("glMultiTexCoord2fARB",         f_glMultiTexCoord2fARB);
   //builtinFunctions.add("glMultiTexCoord2fvARB",        f_glMultiTexCoord2fvARB);
   builtinFunctions.add("glMultiTexCoord2iARB",         f_glMultiTexCoord2iARB);
   //builtinFunctions.add("glMultiTexCoord2ivARB",        f_glMultiTexCoord2ivARB);
   builtinFunctions.add("glMultiTexCoord2sARB",         f_glMultiTexCoord2sARB);
   //builtinFunctions.add("glMultiTexCoord2svARB",        f_glMultiTexCoord2svARB);
   builtinFunctions.add("glMultiTexCoord3dARB",         f_glMultiTexCoord3dARB);
   //builtinFunctions.add("glMultiTexCoord3dvARB",        f_glMultiTexCoord3dvARB);
   builtinFunctions.add("glMultiTexCoord3fARB",         f_glMultiTexCoord3fARB);
   //builtinFunctions.add("glMultiTexCoord3fvARB",        f_glMultiTexCoord3fvARB);
   builtinFunctions.add("glMultiTexCoord3iARB",         f_glMultiTexCoord3iARB);
   //builtinFunctions.add("glMultiTexCoord3ivARB",        f_glMultiTexCoord3ivARB);
   builtinFunctions.add("glMultiTexCoord3sARB",         f_glMultiTexCoord3sARB);
   //builtinFunctions.add("glMultiTexCoord3svARB",        f_glMultiTexCoord3svARB);
   builtinFunctions.add("glMultiTexCoord4dARB",         f_glMultiTexCoord4dARB);
   //builtinFunctions.add("glMultiTexCoord4dvARB",        f_glMultiTexCoord4dvARB);
   builtinFunctions.add("glMultiTexCoord4fARB",         f_glMultiTexCoord4fARB);
   //builtinFunctions.add("glMultiTexCoord4fvARB",        f_glMultiTexCoord4fvARB);
   builtinFunctions.add("glMultiTexCoord4iARB",         f_glMultiTexCoord4iARB);
   //builtinFunctions.add("glMultiTexCoord4ivARB",        f_glMultiTexCoord4ivARB);
   builtinFunctions.add("glMultiTexCoord4sARB",         f_glMultiTexCoord4sARB);
   //builtinFunctions.add("glMultiTexCoord4svARB",        f_glMultiTexCoord4svARB);
   //builtinFunctions.add("glLoadTransposeMatrixfARB",    f_glLoadTransposeMatrixfARB);
   //builtinFunctions.add("glLoadTransposeMatrixdARB",    f_glLoadTransposeMatrixdARB);
   ...
   //builtinFunctions.add("glCompressedTexSubImage3DARB", f_glCompressedTexSubImage3DARB);
   //builtinFunctions.add("glCompressedTexSubImage2DARB", f_glCompressedTexSubImage2DARB);
   //builtinFunctions.add("glCompressedTexSubImage1DARB", f_glCompressedTexSubImage1DARB);
   //builtinFunctions.add("glGetCompressedTexImageARB",   f_glGetCompressedTexImageARB);
   //builtinFunctions.add("glWeightbvARB",                f_glWeightbvARB);
   //builtinFunctions.add("glWeightsvARB",                f_glWeightsvARB);
   //builtinFunctions.add("glWeightivARB",                f_glWeightivARB);
   //builtinFunctions.add("glWeightfvARB",                f_glWeightfvARB);
   //builtinFunctions.add("glWeightdvARB",                f_glWeightdvARB);
   //builtinFunctions.add("glWeightubvARB",               f_glWeightubvARB);
   //builtinFunctions.add("glWeightusvARB",               f_glWeightusvARB);
   //builtinFunctions.add("glWeightuivARB",               f_glWeightuivARB);
   //builtinFunctions.add("glWeightPointerARB",           f_glWeightPointerARB);
   builtinFunctions.add("glVertexBlendARB",             f_glVertexBlendARB);
   builtinFunctions.add("glWindowPos2dARB",             f_glWindowPos2dARB);
   //builtinFunctions.add("glWindowPos2dvARB",            f_glWindowPos2dvARB);
   builtinFunctions.add("glWindowPos2fARB",             f_glWindowPos2fARB);
   //builtinFunctions.add("glWindowPos2fvARB",            f_glWindowPos2fvARB);
   builtinFunctions.add("glWindowPos2iARB",             f_glWindowPos2iARB);
   //builtinFunctions.add("glWindowPos2ivARB",            f_glWindowPos2ivARB);
   builtinFunctions.add("glWindowPos2sARB",             f_glWindowPos2sARB);
   //builtinFunctions.add("glWindowPos2svARB",            f_glWindowPos2svARB);
   builtinFunctions.add("glWindowPos3dARB",             f_glWindowPos3dARB);
   //builtinFunctions.add("glWindowPos3dvARB",            f_glWindowPos3dvARB);
   builtinFunctions.add("glWindowPos3fARB",             f_glWindowPos3fARB);
   //builtinFunctions.add("glWindowPos3fvARB",            f_glWindowPos3fvARB);
   builtinFunctions.add("glWindowPos3iARB",             f_glWindowPos3iARB);
   //builtinFunctions.add("glWindowPos3ivARB",            f_glWindowPos3ivARB);
   builtinFunctions.add("glWindowPos3sARB",             f_glWindowPos3sARB);
   //builtinFunctions.add("glWindowPos3svARB",            f_glWindowPos3svARB);
   //builtinFunctions.add("glGenQueriesARB",              f_glGenQueriesARB);
   //builtinFunctions.add("glDeleteQueriesARB",           f_glDeleteQueriesARB);
   builtinFunctions.add("glIsQueryARB",                 f_glIsQueryARB);
   builtinFunctions.add("glBeginQueryARB",              f_glBeginQueryARB);
   builtinFunctions.add("glEndQueryARB",                f_glEndQueryARB);
   //builtinFunctions.add("glGetQueryivARB",              f_glGetQueryivARB);
   //builtinFunctions.add("glGetQueryObjectivARB",        f_glGetQueryObjectivARB);
   //builtinFunctions.add("glGetQueryObjectuivARB",       f_glGetQueryObjectuivARB);
   builtinFunctions.add("glPointParameterfARB",         f_glPointParameterfARB);
   //builtinFunctions.add("glPointParameterfvARB",        f_glPointParameterfvARB);
   builtinFunctions.add("glBindProgramARB",             f_glBindProgramARB);
   //builtinFunctions.add("glDeleteProgramsARB",          f_glDeleteProgramsARB);
   builtinFunctions.add("glGenProgramsARB",             f_glGenProgramsARB);
   builtinFunctions.add("glIsProgramARB",               f_glIsProgramARB);
   builtinFunctions.add("glProgramEnvParameter4dARB",   f_glProgramEnvParameter4dARB);
   //builtinFunctions.add("glProgramEnvParameter4dvARB",  f_glProgramEnvParameter4dvARB);
   builtinFunctions.add("glProgramEnvParameter4fARB",   f_glProgramEnvParameter4fARB);
   //builtinFunctions.add("glProgramEnvParameter4fvARB",  f_glProgramEnvParameter4fvARB);
   builtinFunctions.add("glProgramLocalParameter4dARB", f_glProgramLocalParameter4dARB);
   //builtinFunctions.add("glProgramLocalParameter4dvARB", f_glProgramLocalParameter4dvARB);
   builtinFunctions.add("glProgramLocalParameter4fARB", f_glProgramLocalParameter4fARB);
   //builtinFunctions.add("glProgramLocalParameter4fvARB", f_glProgramLocalParameter4fvARB);
   //builtinFunctions.add("glGetProgramEnvParameterdvARB", f_glGetProgramEnvParameterdvARB);
   //builtinFunctions.add("glGetProgramEnvParameterfvARB", f_glGetProgramEnvParameterfvARB);
   //builtinFunctions.add("glProgramEnvParameters4fvEXT", f_glProgramEnvParameters4fvEXT);
   //builtinFunctions.add("glProgramLocalParameters4fvEXT", f_glProgramLocalParameters4fvEXT);
   //builtinFunctions.add("glGetProgramLocalParameterdvARB", f_glGetProgramLocalParameterdvARB);
   //builtinFunctions.add("glGetProgramLocalParameterfvARB", f_glGetProgramLocalParameterfvARB);
   builtinFunctions.add("glProgramStringARB",           f_glProgramStringARB);
   //builtinFunctions.add("glGetProgramStringARB",        f_glGetProgramStringARB);
   //builtinFunctions.add("glGetProgramivARB",            f_glGetProgramivARB);
   builtinFunctions.add("glVertexAttrib1dARB",          f_glVertexAttrib1dARB);
   //builtinFunctions.add("glVertexAttrib1dvARB",         f_glVertexAttrib1dvARB);
   builtinFunctions.add("glVertexAttrib1fARB",          f_glVertexAttrib1fARB);
   //builtinFunctions.add("glVertexAttrib1fvARB",         f_glVertexAttrib1fvARB);
   builtinFunctions.add("glVertexAttrib1sARB",          f_glVertexAttrib1sARB);
   //builtinFunctions.add("glVertexAttrib1svARB",         f_glVertexAttrib1svARB);
   builtinFunctions.add("glVertexAttrib2dARB",          f_glVertexAttrib2dARB);
   //builtinFunctions.add("glVertexAttrib2dvARB",         f_glVertexAttrib2dvARB);
   builtinFunctions.add("glVertexAttrib2fARB",          f_glVertexAttrib2fARB);
   //builtinFunctions.add("glVertexAttrib2fvARB",         f_glVertexAttrib2fvARB);
   builtinFunctions.add("glVertexAttrib2sARB",          f_glVertexAttrib2sARB);
   //builtinFunctions.add("glVertexAttrib2svARB",         f_glVertexAttrib2svARB);
   builtinFunctions.add("glVertexAttrib3dARB",          f_glVertexAttrib3dARB);
   //builtinFunctions.add("glVertexAttrib3dvARB",         f_glVertexAttrib3dvARB);
   builtinFunctions.add("glVertexAttrib3fARB",          f_glVertexAttrib3fARB);
   //builtinFunctions.add("glVertexAttrib3fvARB",         f_glVertexAttrib3fvARB);
   builtinFunctions.add("glVertexAttrib3sARB",          f_glVertexAttrib3sARB);
   //builtinFunctions.add("glVertexAttrib3svARB",         f_glVertexAttrib3svARB);
   //builtinFunctions.add("glVertexAttrib4NbvARB",        f_glVertexAttrib4NbvARB);
   //builtinFunctions.add("glVertexAttrib4NivARB",        f_glVertexAttrib4NivARB);
   //builtinFunctions.add("glVertexAttrib4NsvARB",        f_glVertexAttrib4NsvARB);
   builtinFunctions.add("glVertexAttrib4NubARB",        f_glVertexAttrib4NubARB);
   //builtinFunctions.add("glVertexAttrib4NubvARB",       f_glVertexAttrib4NubvARB);
   //builtinFunctions.add("glVertexAttrib4NuivARB",       f_glVertexAttrib4NuivARB);
   //builtinFunctions.add("glVertexAttrib4NusvARB",       f_glVertexAttrib4NusvARB);
   //builtinFunctions.add("glVertexAttrib4bvARB",         f_glVertexAttrib4bvARB);
   builtinFunctions.add("glVertexAttrib4dARB",          f_glVertexAttrib4dARB);
   //builtinFunctions.add("glVertexAttrib4dvARB",         f_glVertexAttrib4dvARB);
   builtinFunctions.add("glVertexAttrib4fARB",          f_glVertexAttrib4fARB);
   //builtinFunctions.add("glVertexAttrib4fvARB",         f_glVertexAttrib4fvARB);
   //builtinFunctions.add("glVertexAttrib4ivARB",         f_glVertexAttrib4ivARB);
   builtinFunctions.add("glVertexAttrib4sARB",          f_glVertexAttrib4sARB);
   //builtinFunctions.add("glVertexAttrib4svARB",         f_glVertexAttrib4svARB);
   //builtinFunctions.add("glVertexAttrib4ubvARB",        f_glVertexAttrib4ubvARB);
   //builtinFunctions.add("glVertexAttrib4uivARB",        f_glVertexAttrib4uivARB);
   //builtinFunctions.add("glVertexAttrib4usvARB",        f_glVertexAttrib4usvARB);
   //builtinFunctions.add("glVertexAttribPointerARB",     f_glVertexAttribPointerARB);
   builtinFunctions.add("glDisableVertexAttribArrayARB", f_glDisableVertexAttribArrayARB);
   builtinFunctions.add("glEnableVertexAttribArrayARB", f_glEnableVertexAttribArrayARB);
   //builtinFunctions.add("glGetVertexAttribPointervARB", f_glGetVertexAttribPointervARB);
   //builtinFunctions.add("glGetVertexAttribdvARB",       f_glGetVertexAttribdvARB);
   //builtinFunctions.add("glGetVertexAttribfvARB",       f_glGetVertexAttribfvARB);
   //builtinFunctions.add("glGetVertexAttribivARB",       f_glGetVertexAttribivARB);
   builtinFunctions.add("glDeleteObjectARB",            f_glDeleteObjectARB);
   //builtinFunctions.add("glGetHandleARB",               f_glGetHandleARB);
   builtinFunctions.add("glDetachObjectARB",            f_glDetachObjectARB);
   //builtinFunctions.add("glCreateShaderObjectARB",      f_glCreateShaderObjectARB);
   //builtinFunctions.add("glShaderSourceARB",            f_glShaderSourceARB);
   builtinFunctions.add("glCompileShaderARB",           f_glCompileShaderARB);
   //builtinFunctions.add("glCreateProgramObjectARB",     f_glCreateProgramObjectARB);
   builtinFunctions.add("glAttachObjectARB",            f_glAttachObjectARB);
   builtinFunctions.add("glLinkProgramARB",             f_glLinkProgramARB);
   builtinFunctions.add("glUseProgramObjectARB",        f_glUseProgramObjectARB);
   builtinFunctions.add("glValidateProgramARB",         f_glValidateProgramARB);
   builtinFunctions.add("glUniform1fARB",               f_glUniform1fARB);
   builtinFunctions.add("glUniform2fARB",               f_glUniform2fARB);
   builtinFunctions.add("glUniform3fARB",               f_glUniform3fARB);
   builtinFunctions.add("glUniform4fARB",               f_glUniform4fARB);
   builtinFunctions.add("glUniform1iARB",               f_glUniform1iARB);
   builtinFunctions.add("glUniform2iARB",               f_glUniform2iARB);
   builtinFunctions.add("glUniform3iARB",               f_glUniform3iARB);
   builtinFunctions.add("glUniform4iARB",               f_glUniform4iARB);
   //builtinFunctions.add("glUniform1fvARB",              f_glUniform1fvARB);
   //builtinFunctions.add("glUniform2fvARB",              f_glUniform2fvARB);
   //builtinFunctions.add("glUniform3fvARB",              f_glUniform3fvARB);
   //builtinFunctions.add("glUniform4fvARB",              f_glUniform4fvARB);
   //builtinFunctions.add("glUniform1ivARB",              f_glUniform1ivARB);
   //builtinFunctions.add("glUniform2ivARB",              f_glUniform2ivARB);
   //builtinFunctions.add("glUniform3ivARB",              f_glUniform3ivARB);
   //builtinFunctions.add("glUniform4ivARB",              f_glUniform4ivARB);
   //builtinFunctions.add("glUniformMatrix2fvARB",        f_glUniformMatrix2fvARB);
   //builtinFunctions.add("glUniformMatrix3fvARB",        f_glUniformMatrix3fvARB);
   //builtinFunctions.add("glUniformMatrix4fvARB",        f_glUniformMatrix4fvARB);
   //builtinFunctions.add("glGetObjectParameterfvARB",    f_glGetObjectParameterfvARB);
   //builtinFunctions.add("glGetObjectParameterivARB",    f_glGetObjectParameterivARB);
   //builtinFunctions.add("glGetInfoLogARB",              f_glGetInfoLogARB);
   //builtinFunctions.add("glGetAttachedObjectsARB",      f_glGetAttachedObjectsARB);
   //builtinFunctions.add("glGetUniformLocationARB",      f_glGetUniformLocationARB);
   //builtinFunctions.add("glGetActiveUniformARB",        f_glGetActiveUniformARB);
   //builtinFunctions.add("glGetUniformfvARB",            f_glGetUniformfvARB);
   //builtinFunctions.add("glGetUniformivARB",            f_glGetUniformivARB);
   //builtinFunctions.add("glGetShaderSourceARB",         f_glGetShaderSourceARB);
   //builtinFunctions.add("glBindAttribLocationARB",      f_glBindAttribLocationARB);
   //builtinFunctions.add("glGetActiveAttribARB",         f_glGetActiveAttribARB);
   //builtinFunctions.add("glGetAttribLocationARB",       f_glGetAttribLocationARB);
   builtinFunctions.add("glBindBufferARB",              f_glBindBufferARB);
   //builtinFunctions.add("glDeleteBuffersARB",           f_glDeleteBuffersARB);
   //builtinFunctions.add("glGenBuffersARB",              f_glGenBuffersARB);
   builtinFunctions.add("glIsBufferARB",                f_glIsBufferARB);
   //builtinFunctions.add("glBufferDataARB",              f_glBufferDataARB);
   //builtinFunctions.add("glBufferSubDataARB",           f_glBufferSubDataARB);
   //builtinFunctions.add("glGetBufferSubDataARB",        f_glGetBufferSubDataARB);
   //builtinFunctions.add("glMapBufferARB",               f_glMapBufferARB);
   builtinFunctions.add("glUnmapBufferARB",             f_glUnmapBufferARB);
   //builtinFunctions.add("glGetBufferParameterivARB",    f_glGetBufferParameterivARB);
   //builtinFunctions.add("glGetBufferPointervARB",       f_glGetBufferPointervARB);
   //builtinFunctions.add("glDrawBuffersARB",             f_glDrawBuffersARB);
   builtinFunctions.add("glBlendColorEXT",              f_glBlendColorEXT);
   builtinFunctions.add("glBlendEquationEXT",           f_glBlendEquationEXT);
   //builtinFunctions.add("glColorTableEXT",              f_glColorTableEXT);
   //builtinFunctions.add("glColorSubTableEXT",           f_glColorSubTableEXT);
   //builtinFunctions.add("glGetColorTableEXT",           f_glGetColorTableEXT);
   //builtinFunctions.add("glGetColorTableParameterivEXT", f_glGetColorTableParameterivEXT);
   //builtinFunctions.add("glGetColorTableParameterfvEXT", f_glGetColorTableParameterfvEXT);
   builtinFunctions.add("glLockArraysEXT",              f_glLockArraysEXT);
   builtinFunctions.add("glUnlockArraysEXT",            f_glUnlockArraysEXT);
   //builtinFunctions.add("glDrawRangeElementsEXT",       f_glDrawRangeElementsEXT);
   builtinFunctions.add("glSecondaryColor3bEXT",        f_glSecondaryColor3bEXT);
   //builtinFunctions.add("glSecondaryColor3bvEXT",       f_glSecondaryColor3bvEXT);
   builtinFunctions.add("glSecondaryColor3dEXT",        f_glSecondaryColor3dEXT);
   //builtinFunctions.add("glSecondaryColor3dvEXT",       f_glSecondaryColor3dvEXT);
   builtinFunctions.add("glSecondaryColor3fEXT",        f_glSecondaryColor3fEXT);
   //builtinFunctions.add("glSecondaryColor3fvEXT",       f_glSecondaryColor3fvEXT);
   builtinFunctions.add("glSecondaryColor3iEXT",        f_glSecondaryColor3iEXT);
   //builtinFunctions.add("glSecondaryColor3ivEXT",       f_glSecondaryColor3ivEXT);
   builtinFunctions.add("glSecondaryColor3sEXT",        f_glSecondaryColor3sEXT);
   //builtinFunctions.add("glSecondaryColor3svEXT",       f_glSecondaryColor3svEXT);
   builtinFunctions.add("glSecondaryColor3ubEXT",       f_glSecondaryColor3ubEXT);
   //builtinFunctions.add("glSecondaryColor3ubvEXT",      f_glSecondaryColor3ubvEXT);
   builtinFunctions.add("glSecondaryColor3uiEXT",       f_glSecondaryColor3uiEXT);
   //builtinFunctions.add("glSecondaryColor3uivEXT",      f_glSecondaryColor3uivEXT);
   builtinFunctions.add("glSecondaryColor3usEXT",       f_glSecondaryColor3usEXT);
   //builtinFunctions.add("glSecondaryColor3usvEXT",      f_glSecondaryColor3usvEXT);
   //builtinFunctions.add("glSecondaryColorPointerEXT",   f_glSecondaryColorPointerEXT);
   //builtinFunctions.add("glMultiDrawArraysEXT",         f_glMultiDrawArraysEXT);
   //builtinFunctions.add("glMultiDrawElementsEXT",       f_glMultiDrawElementsEXT);
   builtinFunctions.add("glFogCoordfEXT",               f_glFogCoordfEXT);
   //builtinFunctions.add("glFogCoordfvEXT",              f_glFogCoordfvEXT);
   builtinFunctions.add("glFogCoorddEXT",               f_glFogCoorddEXT);
   //builtinFunctions.add("glFogCoorddvEXT",              f_glFogCoorddvEXT);
   //builtinFunctions.add("glFogCoordPointerEXT",         f_glFogCoordPointerEXT);
   builtinFunctions.add("glBlendFuncSeparateEXT",       f_glBlendFuncSeparateEXT);
   builtinFunctions.add("glActiveStencilFaceEXT",       f_glActiveStencilFaceEXT);
   builtinFunctions.add("glDepthBoundsEXT",             f_glDepthBoundsEXT);
   builtinFunctions.add("glBlendEquationSeparateEXT",   f_glBlendEquationSeparateEXT);
   builtinFunctions.add("glIsRenderbufferEXT",          f_glIsRenderbufferEXT);
   builtinFunctions.add("glBindRenderbufferEXT",        f_glBindRenderbufferEXT);
   //builtinFunctions.add("glDeleteRenderbuffersEXT",     f_glDeleteRenderbuffersEXT);
   //builtinFunctions.add("glGenRenderbuffersEXT",        f_glGenRenderbuffersEXT);
   builtinFunctions.add("glRenderbufferStorageEXT",     f_glRenderbufferStorageEXT);
   //builtinFunctions.add("glGetRenderbufferParameterivEXT", f_glGetRenderbufferParameterivEXT);
   builtinFunctions.add("glIsFramebufferEXT",           f_glIsFramebufferEXT);
   builtinFunctions.add("glBindFramebufferEXT",         f_glBindFramebufferEXT);
   //builtinFunctions.add("glDeleteFramebuffersEXT",      f_glDeleteFramebuffersEXT);
   builtinFunctions.add("glGenFramebuffersEXT",         f_glGenFramebuffersEXT);
   builtinFunctions.add("glCheckFramebufferStatusEXT",  f_glCheckFramebufferStatusEXT);
   builtinFunctions.add("glFramebufferTexture1DEXT",    f_glFramebufferTexture1DEXT);
   builtinFunctions.add("glFramebufferTexture2DEXT",    f_glFramebufferTexture2DEXT);
   builtinFunctions.add("glFramebufferTexture3DEXT",    f_glFramebufferTexture3DEXT);
   builtinFunctions.add("glFramebufferRenderbufferEXT", f_glFramebufferRenderbufferEXT);
   //builtinFunctions.add("glGetFramebufferAttachmentParameterivEXT", f_glGetFramebufferAttachmentParameterivEXT);
   builtinFunctions.add("glGenerateMipmapEXT",          f_glGenerateMipmapEXT);
   builtinFunctions.add("glBlitFramebufferEXT",         f_glBlitFramebufferEXT);
   builtinFunctions.add("glRenderbufferStorageMultisampleEXT", f_glRenderbufferStorageMultisampleEXT);
   builtinFunctions.add("glProgramParameteriEXT",       f_glProgramParameteriEXT);
   ...
   //builtinFunctions.add("glGetBooleanIndexedvEXT",      f_glGetBooleanIndexedvEXT);
   builtinFunctions.add("glUniformBufferEXT",           f_glUniformBufferEXT);
   builtinFunctions.add("glGetUniformBufferSizeEXT",    f_glGetUniformBufferSizeEXT);
   //builtinFunctions.add("glGetUniformOffsetEXT",        f_glGetUniformOffsetEXT);
   builtinFunctions.add("glClearColorIiEXT",            f_glClearColorIiEXT);
   builtinFunctions.add("glClearColorIuiEXT",           f_glClearColorIuiEXT);
   //builtinFunctions.add("glTexParameterIivEXT",         f_glTexParameterIivEXT);
   //builtinFunctions.add("glTexParameterIuivEXT",        f_glTexParameterIuivEXT);
   //builtinFunctions.add("glGetTexParameterIivEXT",      f_glGetTexParameterIivEXT);
   //builtinFunctions.add("glGetTexParameterIiuvEXT",     f_glGetTexParameterIiuvEXT);
   builtinFunctions.add("glVertexAttribI1iEXT",         f_glVertexAttribI1iEXT);
   builtinFunctions.add("glVertexAttribI2iEXT",         f_glVertexAttribI2iEXT);
   builtinFunctions.add("glVertexAttribI3iEXT",         f_glVertexAttribI3iEXT);
   builtinFunctions.add("glVertexAttribI4iEXT",         f_glVertexAttribI4iEXT);
   builtinFunctions.add("glVertexAttribI1uiEXT",        f_glVertexAttribI1uiEXT);
   builtinFunctions.add("glVertexAttribI2uiEXT",        f_glVertexAttribI2uiEXT);
   builtinFunctions.add("glVertexAttribI3uiEXT",        f_glVertexAttribI3uiEXT);
   builtinFunctions.add("glVertexAttribI4uiEXT",        f_glVertexAttribI4uiEXT);
   //builtinFunctions.add("glVertexAttribI1ivEXT",        f_glVertexAttribI1ivEXT);
   //builtinFunctions.add("glVertexAttribI2ivEXT",        f_glVertexAttribI2ivEXT);
   //builtinFunctions.add("glVertexAttribI3ivEXT",        f_glVertexAttribI3ivEXT);
   //builtinFunctions.add("glVertexAttribI4ivEXT",        f_glVertexAttribI4ivEXT);
   //builtinFunctions.add("glVertexAttribI1uivEXT",       f_glVertexAttribI1uivEXT);
   //builtinFunctions.add("glVertexAttribI2uivEXT",       f_glVertexAttribI2uivEXT);
   //builtinFunctions.add("glVertexAttribI3uivEXT",       f_glVertexAttribI3uivEXT);
   //builtinFunctions.add("glVertexAttribI4uivEXT",       f_glVertexAttribI4uivEXT);
   //builtinFunctions.add("glVertexAttribI4bvEXT",        f_glVertexAttribI4bvEXT);
   //builtinFunctions.add("glVertexAttribI4svEXT",        f_glVertexAttribI4svEXT);
   //builtinFunctions.add("glVertexAttribI4ubvEXT",       f_glVertexAttribI4ubvEXT);
   //builtinFunctions.add("glVertexAttribI4usvEXT",       f_glVertexAttribI4usvEXT);
   //builtinFunctions.add("glVertexAttribIPointerEXT",    f_glVertexAttribIPointerEXT);
   //builtinFunctions.add("glGetVertexAttribIivEXT",      f_glGetVertexAttribIivEXT);
   //builtinFunctions.add("glGetVertexAttribIuivEXT",     f_glGetVertexAttribIuivEXT);
   builtinFunctions.add("glUniform1uiEXT",              f_glUniform1uiEXT);
   builtinFunctions.add("glUniform2uiEXT",              f_glUniform2uiEXT);
   builtinFunctions.add("glUniform3uiEXT",              f_glUniform3uiEXT);
   builtinFunctions.add("glUniform4uiEXT",              f_glUniform4uiEXT);
   //builtinFunctions.add("glUniform1uivEXT",             f_glUniform1uivEXT);
   //builtinFunctions.add("glUniform2uivEXT",             f_glUniform2uivEXT);
   //builtinFunctions.add("glUniform3uivEXT",             f_glUniform3uivEXT);
   //builtinFunctions.add("glUniform4uivEXT",             f_glUniform4uivEXT);
   ...
   //builtinFunctions.add("glFlushVertexArrayRangeAPPLE", f_glFlushVertexArrayRangeAPPLE);
   builtinFunctions.add("glVertexArrayParameteriAPPLE", f_glVertexArrayParameteriAPPLE);
   builtinFunctions.add("glBindVertexArrayAPPLE",       f_glBindVertexArrayAPPLE);
   //builtinFunctions.add("glDeleteVertexArraysAPPLE",    f_glDeleteVertexArraysAPPLE);
   //builtinFunctions.add("glGenVertexArraysAPPLE",       f_glGenVertexArraysAPPLE);
   builtinFunctions.add("glIsVertexArrayAPPLE",         f_glIsVertexArrayAPPLE);
   //builtinFunctions.add("glGenFencesAPPLE",             f_glGenFencesAPPLE);
   //builtinFunctions.add("glDeleteFencesAPPLE",          f_glDeleteFencesAPPLE);
   builtinFunctions.add("glSetFenceAPPLE",              f_glSetFenceAPPLE);
   builtinFunctions.add("glIsFenceAPPLE",               f_glIsFenceAPPLE);
   builtinFunctions.add("glTestFenceAPPLE",             f_glTestFenceAPPLE);
   builtinFunctions.add("glFinishFenceAPPLE",           f_glFinishFenceAPPLE);
   builtinFunctions.add("glTestObjectAPPLE",            f_glTestObjectAPPLE);
   builtinFunctions.add("glFinishObjectAPPLE",          f_glFinishObjectAPPLE);
   //builtinFunctions.add("glElementPointerAPPLE",        f_glElementPointerAPPLE);
   builtinFunctions.add("glDrawElementArrayAPPLE",      f_glDrawElementArrayAPPLE);
   builtinFunctions.add("glDrawRangeElementArrayAPPLE", f_glDrawRangeElementArrayAPPLE);
   //builtinFunctions.add("glMultiDrawElementArrayAPPLE", f_glMultiDrawElementArrayAPPLE);
   //builtinFunctions.add("glMultiDrawRangeElementArrayAPPLE", f_glMultiDrawRangeElementArrayAPPLE);
   builtinFunctions.add("glFlushRenderAPPLE",           f_glFlushRenderAPPLE);
   builtinFunctions.add("glFinishRenderAPPLE",          f_glFinishRenderAPPLE);
   builtinFunctions.add("glSwapAPPLE",                  f_glSwapAPPLE);
   builtinFunctions.add("glEnableVertexAttribAPPLE",    f_glEnableVertexAttribAPPLE);
   builtinFunctions.add("glDisableVertexAttribAPPLE",   f_glDisableVertexAttribAPPLE);
   builtinFunctions.add("glIsVertexAttribEnabledAPPLE", f_glIsVertexAttribEnabledAPPLE);
   //builtinFunctions.add("glMapVertexAttrib1dAPPLE",     f_glMapVertexAttrib1dAPPLE);
   //builtinFunctions.add("glMapVertexAttrib1fAPPLE",     f_glMapVertexAttrib1fAPPLE);
   //builtinFunctions.add("glMapVertexAttrib2dAPPLE",     f_glMapVertexAttrib2dAPPLE);
   //builtinFunctions.add("glMapVertexAttrib2fAPPLE",     f_glMapVertexAttrib2fAPPLE);
   builtinFunctions.add("glBufferParameteriAPPLE",      f_glBufferParameteriAPPLE);
   builtinFunctions.add("glFlushMappedBufferRangeAPPLE", f_glFlushMappedBufferRangeAPPLE);
   ...
   builtinFunctions.add("glCombinerParameteriNV",       f_glCombinerParameteriNV);
   builtinFunctions.add("glCombinerInputNV",            f_glCombinerInputNV);
   builtinFunctions.add("glCombinerOutputNV",           f_glCombinerOutputNV);
   builtinFunctions.add("glFinalCombinerInputNV",       f_glFinalCombinerInputNV);
   //builtinFunctions.add("glGetCombinerInputParameterfvNV", f_glGetCombinerInputParameterfvNV);
   //builtinFunctions.add("glGetCombinerInputParameterivNV", f_glGetCombinerInputParameterivNV);
   //builtinFunctions.add("glGetCombinerOutputParameterfvNV", f_glGetCombinerOutputParameterfvNV);
   //builtinFunctions.add("glGetCombinerOutputParameterivNV", f_glGetCombinerOutputParameterivNV);
   //builtinFunctions.add("glGetFinalCombinerInputParameterfvNV", f_glGetFinalCombinerInputParameterfvNV);
   //builtinFunctions.add("glGetFinalCombinerInputParameterivNV", f_glGetFinalCombinerInputParameterivNV);
   //builtinFunctions.add("glCombinerStageParameterfvNV", f_glCombinerStageParameterfvNV);
   //builtinFunctions.add("glGetCombinerStageParameterfvNV", f_glGetCombinerStageParameterfvNV);
