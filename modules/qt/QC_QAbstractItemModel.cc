...
static void QABSTRACTITEMMODEL_constructor(QoreObject *self, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QABSTRACTITEMMODEL_buddy(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QABSTRACTITEMMODEL_canFetchMore(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QABSTRACTITEMMODEL_columnCount(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_data(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *index = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!index) {
...
static QoreNode *QABSTRACTITEMMODEL_dropMimeData(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QABSTRACTITEMMODEL_fetchMore(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_flags(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *index = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!index) {
...
static QoreNode *QABSTRACTITEMMODEL_hasChildren(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_hasIndex(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int row = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_headerData(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
  {
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QABSTRACTITEMMODEL_index(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int row = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_insertColumn(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int column = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_insertColumns(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int column = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_insertRow(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int row = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_insertRows(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int row = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
//static QoreNode *QABSTRACTITEMMODEL_itemData(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   QoreQModelIndex *index = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
//   if (!index) {
...
//static QoreNode *QABSTRACTITEMMODEL_match(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
...
//static QoreNode *QABSTRACTITEMMODEL_mimeData(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
...
static QoreNode *QABSTRACTITEMMODEL_mimeTypes(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QABSTRACTITEMMODEL_parent(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *index = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!index) {
...
static QoreNode *QABSTRACTITEMMODEL_removeColumn(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int column = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_removeColumns(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int column = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_removeRow(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int row = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_removeRows(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int row = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_rowCount(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_setData(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *index = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!index) {
...
static QoreNode *QABSTRACTITEMMODEL_setHeaderData(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int section = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
//static QoreNode *QABSTRACTITEMMODEL_setItemData(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   QoreQModelIndex *index = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
//   if (!index) {
...
static QoreNode *QABSTRACTITEMMODEL_setSupportedDragActions(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QABSTRACTITEMMODEL_sibling(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int row = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_sort(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int column = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_span(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *index = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!index) {
...
static QoreNode *QABSTRACTITEMMODEL_supportedDragActions(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qaim->getQAbstractItemModel()->supportedDragActions());
}

//virtual Qt::DropActions supportedDropActions () const
static QoreNode *QABSTRACTITEMMODEL_supportedDropActions(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qaim->getQAbstractItemModel()->supportedDropActions());
}

//virtual void revert ()
static QoreNode *QABSTRACTITEMMODEL_revert(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
...
//virtual bool submit ()
static QoreNode *QABSTRACTITEMMODEL_submit(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qaim->getQAbstractItemModel()->submit());
}

//void beginInsertColumns ( const QModelIndex & parent, int first, int last )
static QoreNode *QABSTRACTITEMMODEL_beginInsertColumns(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_beginInsertRows(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_beginRemoveColumns(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_beginRemoveRows(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_changePersistentIndex(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//static QoreNode *QABSTRACTITEMMODEL_changePersistentIndexList(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
...
//static QoreNode *QABSTRACTITEMMODEL_createIndex(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   int row = p ? p->getAsInt() : 0;
//   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_endInsertColumns(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
...
//void endInsertRows ()
static QoreNode *QABSTRACTITEMMODEL_endInsertRows(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   qaim->endInsertRows();
   return 0;
}
...
static QoreNode *QABSTRACTITEMMODEL_endRemoveColumns(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
...
//void endRemoveRows ()
static QoreNode *QABSTRACTITEMMODEL_endRemoveRows(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   qaim->endRemoveRows();
   return 0;
}
...
//static QoreNode *QABSTRACTITEMMODEL_persistentIndexList(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreNode((int64)qaim->persistentIndexList());
//}

//void reset ()
static QoreNode *QABSTRACTITEMMODEL_reset(QoreObject *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   qaim->reset();
   return 0;
}
