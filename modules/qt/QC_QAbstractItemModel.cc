...
static QoreNode *QABSTRACTITEMMODEL_beginInsertColumns(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_beginInsertRows(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_beginRemoveColumns(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_beginRemoveRows(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQModelIndex *parent = (p && p->type == NT_OBJECT) ? (QoreQModelIndex *)p->val.object->getReferencedPrivateData(CID_QMODELINDEX, xsink) : 0;
   if (!parent) {
...
static QoreNode *QABSTRACTITEMMODEL_changePersistentIndex(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//static QoreNode *QABSTRACTITEMMODEL_changePersistentIndexList(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
...
//static QoreNode *QABSTRACTITEMMODEL_createIndex(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   int row = p ? p->getAsInt() : 0;
//   p = get_param(params, 1);
...
static QoreNode *QABSTRACTITEMMODEL_endInsertColumns(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
...
//void endInsertRows ()
static QoreNode *QABSTRACTITEMMODEL_endInsertRows(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   qaim->endInsertRows();
   return 0;
}
...
static QoreNode *QABSTRACTITEMMODEL_endRemoveColumns(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
...
//void endRemoveRows ()
static QoreNode *QABSTRACTITEMMODEL_endRemoveRows(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   qaim->endRemoveRows();
   return 0;
}
...
//static QoreNode *QABSTRACTITEMMODEL_persistentIndexList(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreNode((int64)qaim->persistentIndexList());
//}

//void reset ()
static QoreNode *QABSTRACTITEMMODEL_reset(Object *self, QoreAbstractQAbstractItemModel *qaim, QoreNode *params, ExceptionSink *xsink)
{
   qaim->reset();
   return 0;
}
