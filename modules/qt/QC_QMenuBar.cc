...
static void QMENUBAR_constructor(Object *self, QoreNode *params, ExceptionSink *xsink)
{
...
static void QMENUBAR_copy(class Object *self, class Object *old, class QoreQMenuBar *qmb, ExceptionSink *xsink)
{
   xsink->raiseException("QMENUBAR-COPY-ERROR", "objects of this class cannot be copied");
}

//QAction * activeAction () const
static QoreNode *QMENUBAR_activeAction(Object *self, QoreAbstractQMenuBar *qmb, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QMENUBAR_addAction(Object *self, QoreAbstractQMenuBar *qmb, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QString text;
...
static QoreNode *QMENUBAR_addMenu(Object *self, QoreAbstractQMenuBar *qmb, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMENUBAR_addSeparator(Object *self, QoreAbstractQMenuBar *qmb, QoreNode *params, ExceptionSink *xsink)
{
...
//void clear ()
static QoreNode *QMENUBAR_clear(Object *self, QoreAbstractQMenuBar *qmb, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QMENUBAR_insertMenu(Object *self, QoreAbstractQMenuBar *qmb, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMENUBAR_insertSeparator(Object *self, QoreAbstractQMenuBar *qmb, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreAbstractQAction *before = (p && p->type == NT_OBJECT) ? (QoreAbstractQAction *)p->val.object->getReferencedPrivateData(CID_QACTION, xsink) : 0;
   if (!before) {
...
static QoreNode *QMENUBAR_isDefaultUp(Object *self, QoreAbstractQMenuBar *qmb, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qmb->getQMenuBar()->isDefaultUp());
}

//void setActiveAction ( QAction * act )
static QoreNode *QMENUBAR_setActiveAction(Object *self, QoreAbstractQMenuBar *qmb, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMENUBAR_setDefaultUp(Object *self, QoreAbstractQMenuBar *qmb, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
