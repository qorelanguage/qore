...
static void QMOVIE_constructor(QoreObject *self, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QMOVIE_backgroundColor(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QMOVIE_cacheMode(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qm->qobj->cacheMode());
}

//int currentFrameNumber () const
static QoreNode *QMOVIE_currentFrameNumber(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qm->qobj->currentFrameNumber());
}

//QImage currentImage () const
static QoreNode *QMOVIE_currentImage(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QMOVIE_currentPixmap(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QMOVIE_device(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QMOVIE_format(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QMOVIE_frameCount(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qm->qobj->frameCount());
}

//QRect frameRect () const
static QoreNode *QMOVIE_frameRect(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
...
//bool isValid () const
static QoreNode *QMOVIE_isValid(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qm->qobj->isValid());
}

//bool jumpToFrame ( int frameNumber )
static QoreNode *QMOVIE_jumpToFrame(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//int loopCount () const
static QoreNode *QMOVIE_loopCount(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qm->qobj->loopCount());
}

//int nextFrameDelay () const
static QoreNode *QMOVIE_nextFrameDelay(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qm->qobj->nextFrameDelay());
}

//QSize scaledSize ()
static QoreNode *QMOVIE_scaledSize(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QMOVIE_setBackgroundColor(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOVIE_setCacheMode(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOVIE_setDevice(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   ??? QIODevice* device = p;
...
static QoreNode *QMOVIE_setFileName(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QString fileName;
   if (get_qstring(p, fileName, xsink))
...
static QoreNode *QMOVIE_setFormat(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QByteArray format;
...
static QoreNode *QMOVIE_setScaledSize(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//int speed () const
static QoreNode *QMOVIE_speed(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qm->qobj->speed());
}

//MovieState state () const
static QoreNode *QMOVIE_state(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qm->qobj->state());
}

//bool jumpToNextFrame ()
static QoreNode *QMOVIE_jumpToNextFrame(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qm->qobj->jumpToNextFrame());
}

//void setPaused ( bool paused )
static QoreNode *QMOVIE_setPaused(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOVIE_setSpeed(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//void start ()
static QoreNode *QMOVIE_start(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   qm->qobj->start();
   return 0;
}
...
//void stop ()
static QoreNode *QMOVIE_stop(QoreObject *self, QoreQMovie *qm, const QoreNode *params, ExceptionSink *xsink)
{
   qm->qobj->stop();
   return 0;
}
...
static QoreNode *f_QMovie_supportedFormats(const QoreNode *params, ExceptionSink *xsink)
{
