...
static void QFILEINFO_constructor(QoreObject *self, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QFILEINFO_absoluteDir(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
...
//bool caching () const
static QoreNode *QFILEINFO_caching(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QFILEINFO_created(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
...
//QDir dir () const
static QoreNode *QFILEINFO_dir(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   QoreObject *o_qd = new QoreObject(QC_QDir, getProgram());
...
//bool exists () const
static QoreNode *QFILEINFO_exists(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
...
//uint groupId () const
static QoreNode *QFILEINFO_groupId(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qfi->groupId());
}

//bool isAbsolute () const
static QoreNode *QFILEINFO_isAbsolute(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isAbsolute());
}

//bool isBundle () const
static QoreNode *QFILEINFO_isBundle(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isBundle());
}

//bool isDir () const
static QoreNode *QFILEINFO_isDir(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isDir());
}

//bool isExecutable () const
static QoreNode *QFILEINFO_isExecutable(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isExecutable());
}

//bool isFile () const
static QoreNode *QFILEINFO_isFile(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isFile());
}

//bool isHidden () const
static QoreNode *QFILEINFO_isHidden(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isHidden());
}

//bool isReadable () const
static QoreNode *QFILEINFO_isReadable(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isReadable());
}

//bool isRelative () const
static QoreNode *QFILEINFO_isRelative(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isRelative());
}

//bool isRoot () const
static QoreNode *QFILEINFO_isRoot(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isRoot());
}

//bool isSymLink () const
static QoreNode *QFILEINFO_isSymLink(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isSymLink());
}

//bool isWritable () const
static QoreNode *QFILEINFO_isWritable(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qfi->isWritable());
}

//QDateTime lastModified () const
static QoreNode *QFILEINFO_lastModified(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QFILEINFO_lastRead(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
...
//bool makeAbsolute ()
static QoreNode *QFILEINFO_makeAbsolute(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
...
//uint ownerId () const
static QoreNode *QFILEINFO_ownerId(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QFILEINFO_permission(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QFILEINFO_permissions(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qfi->permissions());
}

//void refresh ()
static QoreNode *QFILEINFO_refresh(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   qfi->refresh();
   return 0;
}
...
static QoreNode *QFILEINFO_setCaching(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QFILEINFO_setFile(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   if (p && p->type == NT_OBJECT) {
      QoreQDir *dir = (QoreQDir *)p->val.object->getReferencedPrivateData(CID_QDIR, xsink);
...
//qint64 size () const
static QoreNode *QFILEINFO_size(QoreObject *self, QoreQFileInfo *qfi, const QoreNode *params, ExceptionSink *xsink)
{
