...
//int batchSize () const
static QoreNode *QLISTVIEW_batchSize(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qlv->getQListView()->batchSize());
}

//void clearPropertyFlags ()
static QoreNode *QLISTVIEW_clearPropertyFlags(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
...
//Flow flow () const
static QoreNode *QLISTVIEW_flow(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qlv->getQListView()->flow());
}

//QSize gridSize () const
static QoreNode *QLISTVIEW_gridSize(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QLISTVIEW_isRowHidden(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_isSelectionRectVisible(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBoolNode(qlv->getQListView()->isSelectionRectVisible());
}

//bool isWrapping () const
static QoreNode *QLISTVIEW_isWrapping(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBoolNode(qlv->getQListView()->isWrapping());
}

//LayoutMode layoutMode () const
static QoreNode *QLISTVIEW_layoutMode(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qlv->getQListView()->layoutMode());
}

//int modelColumn () const
static QoreNode *QLISTVIEW_modelColumn(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qlv->getQListView()->modelColumn());
}

//Movement movement () const
static QoreNode *QLISTVIEW_movement(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qlv->getQListView()->movement());
}

//ResizeMode resizeMode () const
static QoreNode *QLISTVIEW_resizeMode(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qlv->getQListView()->resizeMode());
}

//void setBatchSize ( int batchSize )
static QoreNode *QLISTVIEW_setBatchSize(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setFlow(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setGridSize(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setLayoutMode(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setModelColumn(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setMovement(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setResizeMode(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setRowHidden(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int row = p ? p->getAsInt() : 0;
...
static QoreNode *QLISTVIEW_setSelectionRectVisible(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setSpacing(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setUniformItemSizes(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setViewMode(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setWordWrap(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setWrapping(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   bool enable = p ? p->getAsBool() : false;
...
//int spacing () const
static QoreNode *QLISTVIEW_spacing(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qlv->getQListView()->spacing());
}

//bool uniformItemSizes () const
static QoreNode *QLISTVIEW_uniformItemSizes(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBoolNode(qlv->getQListView()->uniformItemSizes());
}

//ViewMode viewMode () const
static QoreNode *QLISTVIEW_viewMode(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qlv->getQListView()->viewMode());
}

//bool wordWrap () const
static QoreNode *QLISTVIEW_wordWrap(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBoolNode(qlv->getQListView()->wordWrap());
}

//QRect rectForIndex ( const QModelIndex & index ) const
static QoreNode *QLISTVIEW_rectForIndex(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setPositionForIndex(QoreObject *self, QoreAbstractQListView *qlv, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
