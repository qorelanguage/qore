...
static void QLISTVIEW_constructor(Object *self, QoreNode *params, ExceptionSink *xsink)
{
...
static void QLISTVIEW_copy(class Object *self, class Object *old, class QoreQListView *qlv, ExceptionSink *xsink)
{
   xsink->raiseException("QLISTVIEW-COPY-ERROR", "objects of this class cannot be copied");
}

//int batchSize () const
static QoreNode *QLISTVIEW_batchSize(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qlv->getQListView()->batchSize());
}

//void clearPropertyFlags ()
static QoreNode *QLISTVIEW_clearPropertyFlags(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
...
//Flow flow () const
static QoreNode *QLISTVIEW_flow(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qlv->getQListView()->flow());
}

//QSize gridSize () const
static QoreNode *QLISTVIEW_gridSize(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QLISTVIEW_isRowHidden(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_isSelectionRectVisible(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qlv->getQListView()->isSelectionRectVisible());
}

//bool isWrapping () const
static QoreNode *QLISTVIEW_isWrapping(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qlv->getQListView()->isWrapping());
}

//LayoutMode layoutMode () const
static QoreNode *QLISTVIEW_layoutMode(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qlv->getQListView()->layoutMode());
}

//int modelColumn () const
static QoreNode *QLISTVIEW_modelColumn(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qlv->getQListView()->modelColumn());
}

//Movement movement () const
static QoreNode *QLISTVIEW_movement(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qlv->getQListView()->movement());
}

//ResizeMode resizeMode () const
static QoreNode *QLISTVIEW_resizeMode(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qlv->getQListView()->resizeMode());
}

//void setBatchSize ( int batchSize )
static QoreNode *QLISTVIEW_setBatchSize(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setFlow(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setGridSize(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setLayoutMode(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setModelColumn(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setMovement(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setResizeMode(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setRowHidden(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int row = p ? p->getAsInt() : 0;
...
static QoreNode *QLISTVIEW_setSelectionRectVisible(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setSpacing(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setUniformItemSizes(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setViewMode(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setWordWrap(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setWrapping(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   bool enable = p ? p->getAsBool() : false;
...
//int spacing () const
static QoreNode *QLISTVIEW_spacing(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qlv->getQListView()->spacing());
}

//bool uniformItemSizes () const
static QoreNode *QLISTVIEW_uniformItemSizes(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qlv->getQListView()->uniformItemSizes());
}

//ViewMode viewMode () const
static QoreNode *QLISTVIEW_viewMode(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qlv->getQListView()->viewMode());
}

//bool wordWrap () const
static QoreNode *QLISTVIEW_wordWrap(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qlv->getQListView()->wordWrap());
}

//QRect rectForIndex ( const QModelIndex & index ) const
static QoreNode *QLISTVIEW_rectForIndex(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QLISTVIEW_setPositionForIndex(Object *self, QoreAbstractQListView *qlv, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
