...
static void QPAINTENGINE_constructor(Object *self, QoreNode *params, ExceptionSink *xsink)
{
   xsink->raiseException("QPAINTENGINE-CONSTRUCTOR-ERROR", "QPaintEngine is an abstract class");
}

static void QPAINTENGINE_copy(class Object *self, class Object *old, class QoreQPaintEngine *qpe, ExceptionSink *xsink)
{
   xsink->raiseException("QPAINTENGINE-COPY-ERROR", "objects of this class cannot be copied");
}

//virtual bool begin ( QPaintDevice * pdev ) = 0
static QoreNode *QPAINTENGINE_begin(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QPAINTENGINE_drawEllipse(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QPAINTENGINE_drawImage(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QPAINTENGINE_drawLines(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = test_param(params, NT_OBJECT, 0);
...
static QoreNode *QPAINTENGINE_drawPath(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QPAINTENGINE_drawPixmap(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QPAINTENGINE_drawPoints(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = test_param(params, NT_OBJECT, 0);
...
static QoreNode *QPAINTENGINE_drawPolygon(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = test_param(params, NT_OBJECT, 0);
   QoreQPoint *points = p ? (QoreQPoint *)p->val.object->getReferencedPrivateData(CID_QPOINT, xsink) : 0;
   if (!points) {
...
static QoreNode *QPAINTENGINE_drawRects(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QPAINTENGINE_drawTextItem(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QPAINTENGINE_drawTiledPixmap(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//virtual bool end () = 0
static QoreNode *QPAINTENGINE_end(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qpe->getQPaintEngine()->end());
}

//bool hasFeature ( PaintEngineFeatures feature ) const
static QoreNode *QPAINTENGINE_hasFeature(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//bool isActive () const
static QoreNode *QPAINTENGINE_isActive(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qpe->getQPaintEngine()->isActive());
}

//QPaintDevice * paintDevice () const
static QoreNode *QPAINTENGINE_paintDevice(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   ...
   Object *o = new Object(QC_QPaintDevice, getProgram());
   o->setPrivate(CID_QPAINTDEVICE, new QoreQtQPaintDevice(qpd));
   return new QoreNode(o);
}

//QPainter * painter () const
static QoreNode *QPAINTENGINE_painter(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   Object *o_qp = new Object(QC_QPainter, getProgram());
...
static QoreNode *QPAINTENGINE_setActive(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QPAINTENGINE_type(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QPAINTENGINE_updateState(Object *self, QoreAbstractQPaintEngine *qpe, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
