...
static void QLCDNUMBER_constructor(class QoreObject *self, const QoreNode *params, ExceptionSink *xsink)
{
...
static class QoreNode *QLCDNUMBER_setSegmentStyle(class QoreObject *self, class QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
...
static class QoreNode *QLCDNUMBER_setNumDigits(class QoreObject *self, class QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
   class QoreNode *p = get_param(params, 0);
   if (!is_nothing(p))
...
static class QoreNode *QLCDNUMBER_numDigits(class QoreObject *self, class QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qlcdn->qobj->numDigits());
}

static class QoreNode *QLCDNUMBER_smallDecimalPoint(class QoreObject *self, class QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qlcdn->qobj->smallDecimalPoint());
}

static class QoreNode *QLCDNUMBER_value(class QoreObject *self, class QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qlcdn->qobj->value());
}

static class QoreNode *QLCDNUMBER_intValue(class QoreObject *self, class QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qlcdn->qobj->intValue());
}

static class QoreNode *QLCDNUMBER_setMode(class QoreObject *self, class QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
   class QoreNode *p = get_param(params, 0);
   if (!is_nothing(p))
...
static class QoreNode *QLCDNUMBER_checkOverflow(class QoreObject *self, class QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
   class QoreNode *p = get_param(params, 0);
   bool rc;
...
static QoreNode *QLCDNUMBER_display(QoreObject *self, QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   if (p && p->type == NT_FLOAT)
...
//void setBinMode ()
static QoreNode *QLCDNUMBER_setBinMode(QoreObject *self, QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
...
//void setDecMode ()
static QoreNode *QLCDNUMBER_setDecMode(QoreObject *self, QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
...
//void setHexMode ()
static QoreNode *QLCDNUMBER_setHexMode(QoreObject *self, QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
...
//void setOctMode ()
static QoreNode *QLCDNUMBER_setOctMode(QoreObject *self, QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QLCDNUMBER_setSmallDecimalPoint(QoreObject *self, QoreQLCDNumber *qlcdn, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
