...
static QoreNode *QSYSTEMTRAYICON_contextMenu(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QSYSTEMTRAYICON_geometry(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
...
//QIcon icon () const
static QoreNode *QSYSTEMTRAYICON_icon(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QSYSTEMTRAYICON_isVisible(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBoolNode(qsti->qobj->isVisible());
}

//void setContextMenu ( QMenu * menu )
static QoreNode *QSYSTEMTRAYICON_setContextMenu(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QSYSTEMTRAYICON_setIcon(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QSYSTEMTRAYICON_setToolTip(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QString tip;
...
static QoreNode *QSYSTEMTRAYICON_showMessage(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QString title;
...
static QoreNode *QSYSTEMTRAYICON_toolTip(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreStringNode(qsti->qobj->toolTip().toUtf8().data(), QCS_UTF8);
}

//void hide ()
static QoreNode *QSYSTEMTRAYICON_hide(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
   qsti->qobj->hide();
   return 0;
}
...
static QoreNode *QSYSTEMTRAYICON_setVisible(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//void show ()
static QoreNode *QSYSTEMTRAYICON_show(QoreObject *self, QoreQSystemTrayIcon *qsti, const QoreListNode *params, ExceptionSink *xsink)
{
   qsti->qobj->show();
   return 0;
}
...
static QoreNode *f_QSystemTrayIcon_isSystemTrayAvailable(const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBoolNode(QSystemTrayIcon::isSystemTrayAvailable());
}

//bool supportsMessages ()
static QoreNode *f_QSystemTrayIcon_supportsMessages(const QoreListNode *params, ExceptionSink *xsink)
{
