...
//   return new QoreNode(qr->contains(point, proper));
//}
...
//   ??? QPoint offset = p;
//
//   QoreQRect *q_qr = new QoreQRect(qr->translated(offset));
//   Object *o_qr = new Object(self->getClass(CID_QRECT), getProgram());
//   o_qr->setPrivate(CID_QRECT, q_qr);
//   return new QoreNode(o_qr);
//}
...
class QoreClass *initQRectClass()
{
   ...
   class QoreClass *QC_QRect = new QoreClass("QRect", QDOM_GUI);
