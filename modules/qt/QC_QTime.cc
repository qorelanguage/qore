...
static void QTIME_constructor(class Object *self, class QoreNode *params, ExceptionSink *xsink)
{
   QoreQTime *qdt;
...
static QoreNode *QTIME_addMSecs(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int ms = p ? p->getAsInt() : 0;
   Object *o_qt = new Object(self->getClass(CID_QTIME), getProgram());
...
static QoreNode *QTIME_addSecs(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int s = p ? p->getAsInt() : 0;
   Object *o_qt = new Object(self->getClass(CID_QTIME), getProgram());
...
//int elapsed () const
static QoreNode *QTIME_elapsed(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qt->elapsed());
}

//int hour () const
static QoreNode *QTIME_hour(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qt->hour());
}

//bool isNull () const
static QoreNode *QTIME_isNull(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qt->isNull());
}

//bool isValid () const
static QoreNode *QTIME_isValid(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qt->isValid());
}

//int minute () const
static QoreNode *QTIME_minute(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qt->minute());
}

//int msec () const
static QoreNode *QTIME_msec(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qt->msec());
}

//int msecsTo ( const QTime & t ) const
static QoreNode *QTIME_msecsTo(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//int restart ()
static QoreNode *QTIME_restart(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qt->restart());
}

//int second () const
static QoreNode *QTIME_second(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qt->second());
}

//int secsTo ( const QTime & t ) const
static QoreNode *QTIME_secsTo(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQTime *t = (p && p->type == NT_OBJECT) ? (QoreQTime *)p->val.object->getReferencedPrivateData(CID_QTIME, xsink) : 0;
   if (!t) {
...
static QoreNode *QTIME_setHMS(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int h = p ? p->getAsInt() : 0;
   p = get_param(params, 1);
...
//void start ()
static QoreNode *QTIME_start(Object *self, QoreQTime *qt, QoreNode *params, ExceptionSink *xsink)
{
   qt->start();
   return 0;
}
