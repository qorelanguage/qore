...
static QoreNode *QSTYLE_drawItemPixmap(Object *self, QoreAbstractQStyle *qs, QoreNode *params, ExceptionSink *xsink)
{
   ...
   qs->getQStyle()->drawItemPixmap(static_cast<QPainter *>(painter), *(static_cast<QRect *>(rectangle)), alignment, *(static_cast<QPixmap *>(pixmap)));
   return 0;
}
...
static QoreNode *QSTYLE_drawItemText(Object *self, QoreAbstractQStyle *qs, QoreNode *params, ExceptionSink *xsink)
{
   ...
   qs->getQStyle()->drawItemText(static_cast<QPainter *>(painter), *(static_cast<QRect *>(rectangle)), alignment, *(static_cast<QPalette *>(palette)), enabled, text, textRole);
   return 0;
}
...
QoreClass *initQStyleClass(QoreClass *qobject)
{
   ...
   QC_QStyle->addMethod("layoutSpacingImplementation", (q_method_t)QSTYLE_layoutSpacingImplementation);
   QC_QStyle->addMethod("standardIconImplementation",  (q_method_t)QSTYLE_standardIconImplementation);
