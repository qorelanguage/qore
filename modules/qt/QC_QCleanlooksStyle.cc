...
//QCleanlooksStyle ()
static void QCLEANLOOKSSTYLE_constructor(QoreObject *self, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QCLEANLOOKSSTYLE_drawItemText(QoreObject *self, QoreAbstractQCleanlooksStyle *qcs, const QoreNode *params, ExceptionSink *xsink)
{
