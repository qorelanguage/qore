...
static void QTEXTLENGTH_constructor(QoreObject *self, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QTEXTLENGTH_rawValue(QoreObject *self, QoreQTextLength *qtl, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((double)qtl->rawValue());
}

//Type type () const
static QoreNode *QTEXTLENGTH_type(QoreObject *self, QoreQTextLength *qtl, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qtl->type());
}

//qreal value ( qreal maximumLength ) const
static QoreNode *QTEXTLENGTH_value(QoreObject *self, QoreQTextLength *qtl, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
