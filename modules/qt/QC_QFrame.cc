...
static void QFRAME_constructor(class QoreObject *self, const QoreList *params, ExceptionSink *xsink)
{
   QoreQFrame *qw;
...
static QoreNode *QFRAME_frameRect(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QFRAME_frameShadow(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qf->getQFrame()->frameShadow());
}

//Shape frameShape () const
static QoreNode *QFRAME_frameShape(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qf->getQFrame()->frameShape());
}

//int frameStyle () const
static QoreNode *QFRAME_frameStyle(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qf->getQFrame()->frameStyle());
}

//int frameWidth () const
static QoreNode *QFRAME_frameWidth(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qf->getQFrame()->frameWidth());
}

//int lineWidth () const
static QoreNode *QFRAME_lineWidth(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qf->getQFrame()->lineWidth());
}

//int midLineWidth () const
static QoreNode *QFRAME_midLineWidth(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QFRAME_setFrameShadow(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QFRAME_setFrameShape(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QFRAME_setFrameStyle(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QFRAME_setLineWidth(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QFRAME_setMidLineWidth(QoreObject *self, QoreAbstractQFrame *qf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int x = p ? p->getAsInt() : 0;
