...
static void QSIZE_constructor(class Object *self, class QoreNode *params, ExceptionSink *xsink)
{
   QoreQSize *qr;
...
static QoreNode *QSIZE_boundedTo(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   ...
   Object *o_qs = new Object(self->getClass(CID_QSIZE), getProgram());
...
static QoreNode *QSIZE_expandedTo(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQSize *otherSize = (p && p->type == NT_OBJECT) ? (QoreQSize *)p->val.object->getReferencedPrivateData(CID_QSIZE, xsink) : 0;
   if (!otherSize) {
...
//int height () const
static QoreNode *QSIZE_height(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qs->height());
}

//bool isEmpty () const
static QoreNode *QSIZE_isEmpty(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qs->isEmpty());
}

//bool isNull () const
static QoreNode *QSIZE_isNull(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qs->isNull());
}

//bool isValid () const
static QoreNode *QSIZE_isValid(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qs->isValid());
}

//int & rheight ()
//static QoreNode *QSIZE_rheight(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreNode((int64)qs->rheight());
//}

//int & rwidth ()
//static QoreNode *QSIZE_rwidth(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
//{
...
static QoreNode *QSIZE_scale(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QSIZE_setHeight(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int height = p ? p->getAsInt() : 0;
   qs->setHeight(height);
...
static QoreNode *QSIZE_setWidth(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int width = p ? p->getAsInt() : 0;
   qs->setWidth(width);
...
//void transpose ()
static QoreNode *QSIZE_transpose(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
   qs->transpose();
   return 0;
}
...
//int width () const
static QoreNode *QSIZE_width(Object *self, QoreQSize *qs, QoreNode *params, ExceptionSink *xsink)
{
