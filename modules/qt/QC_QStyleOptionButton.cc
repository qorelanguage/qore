...
static void QSTYLEOPTIONBUTTON_constructor(QoreObject *self, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QSTYLEOPTIONBUTTON_features(QoreObject *self, QoreQStyleOptionButton *qsob, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qsob->features);
}

//QIcon icon ()
static QoreNode *QSTYLEOPTIONBUTTON_icon(QoreObject *self, QoreQStyleOptionButton *qsob, const QoreList *params, ExceptionSink *xsink)
{
...
//QSize iconSize ()
static QoreNode *QSTYLEOPTIONBUTTON_iconSize(QoreObject *self, QoreQStyleOptionButton *qsob, const QoreList *params, ExceptionSink *xsink)
{
...
//QString text ()
static QoreNode *QSTYLEOPTIONBUTTON_text(QoreObject *self, QoreQStyleOptionButton *qsob, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreStringNode(qsob->text.toUtf8().data(), QCS_UTF8);
}

//void setFeatures ( ButtonFeatures features )
static QoreNode *QSTYLEOPTIONBUTTON_setFeatures(QoreObject *self, QoreQStyleOptionButton *qsob, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QSTYLEOPTIONBUTTON_setText(QoreObject *self, QoreQStyleOptionButton *qsob, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QString text;
