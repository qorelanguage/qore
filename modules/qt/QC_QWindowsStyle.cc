...
//QWindowsStyle ()
static void QWINDOWSSTYLE_constructor(QoreObject *self, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QWINDOWSSTYLE_drawComplexControl(QoreObject *self, QoreAbstractQWindowsStyle *qws, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QWINDOWSSTYLE_drawControl(QoreObject *self, QoreAbstractQWindowsStyle *qws, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QWINDOWSSTYLE_drawPrimitive(QoreObject *self, QoreAbstractQWindowsStyle *qws, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QWINDOWSSTYLE_generatedIconPixmap(QoreObject *self, QoreAbstractQWindowsStyle *qws, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QWINDOWSSTYLE_hitTestComplexControl(QoreObject *self, QoreAbstractQWindowsStyle *qws, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QWindowsStyle::ComplexControl control = (QWindowsStyle::ComplexControl)(p ? p->getAsInt() : 0);
   p = get_param(params, 1);
   ...
   if (*xsink)
      return 0;
   ReferenceHolder<AbstractPrivateData> widgetHolder(static_cast<AbstractPrivateData *>(widget), xsink);
   return new QoreNode((int64)qws->hitTestComplexControl(control, static_cast<QStyleOptionComplex *>(option), *(static_cast<QPoint *>(position)), widget ? static_cast<QWidget *>(widget->getQWidget()) : 0));
}

//virtual int pixelMetric ( PixelMetric metric, const QStyleOption * option = 0, const QWidget * widget = 0 ) const = 0
static QoreNode *QWINDOWSSTYLE_pixelMetric(QoreObject *self, QoreAbstractQWindowsStyle *qws, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   ...
   if (*xsink)
      return 0;
   ReferenceHolder<AbstractPrivateData> widgetHolder(static_cast<AbstractPrivateData *>(widget), xsink);
   return new QoreNode((int64)qws->pixelMetric(metric, option ? static_cast<QStyleOption *>(option) : 0, widget ? static_cast<QWidget *>(widget->getQWidget()) : 0));
}
...
static QoreNode *QWINDOWSSTYLE_sizeFromContents(QoreObject *self, QoreAbstractQWindowsStyle *qws, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QWINDOWSSTYLE_styleHint(QoreObject *self, QoreAbstractQWindowsStyle *qws, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//   ??? QStyleHintReturn* returnData = p;
   return new QoreNode((int64)qws->styleHint(hint, option ? static_cast<QStyleOption *>(option) : 0, widget ? static_cast<QWidget *>(widget->getQWidget()) : 0));
}
...
static QoreNode *QWINDOWSSTYLE_subControlRect(QoreObject *self, QoreAbstractQWindowsStyle *qws, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QWindowsStyle::ComplexControl control = (QWindowsStyle::ComplexControl)(p ? p->getAsInt() : 0);
   p = get_param(params, 1);
...
static QoreNode *QWINDOWSSTYLE_subElementRect(QoreObject *self, QoreAbstractQWindowsStyle *qws, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
