...
static QoreNode *QRECTF_adjust(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QRECTF_adjusted(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float dx1 = p ? p->getAsFloat() : 0;
   p = get_param(params, 1);
...
//qreal bottom () const
static QoreNode *QRECTF_bottom(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qrf->bottom());
}

//QPointF bottomLeft () const
//static QoreNode *QRECTF_bottomLeft(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreNode((int64)qrf->bottomLeft());
//}

//QPointF bottomRight () const
//static QoreNode *QRECTF_bottomRight(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreNode((int64)qrf->bottomRight());
//}

//QPointF center () const
//static QoreNode *QRECTF_center(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreNode((int64)qrf->center());
//}

//bool contains ( const QPointF & point ) const
//static QoreNode *QRECTF_contains(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QPointF point = p;
...
//static QoreNode *QRECTF_getCoords(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? qreal* x1 = p;
//   p = get_param(params, 1);
...
//static QoreNode *QRECTF_getRect(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? qreal* x = p;
//   p = get_param(params, 1);
...
//qreal height () const
static QoreNode *QRECTF_height(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qrf->height());
}

//QRectF intersected ( const QRectF & rectangle ) const
static QoreNode *QRECTF_intersected(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QRECTF_intersects(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQRectF *rectangle = (p && p->type == NT_OBJECT) ? (QoreQRectF *)p->val.object->getReferencedPrivateData(CID_QRECTF, xsink) : 0;
   if (!p || !rectangle)
...
//bool isEmpty () const
static QoreNode *QRECTF_isEmpty(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qrf->isEmpty());
}

//bool isNull () const
static QoreNode *QRECTF_isNull(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qrf->isNull());
}

//bool isValid () const
static QoreNode *QRECTF_isValid(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qrf->isValid());
}

//qreal left () const
static QoreNode *QRECTF_left(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qrf->left());
}

//void moveBottom ( qreal y )
static QoreNode *QRECTF_moveBottom(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float y = p ? p->getAsFloat() : 0;
   qrf->moveBottom(y);
...
//static QoreNode *QRECTF_moveBottomLeft(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QPointF position = p;
...
//static QoreNode *QRECTF_moveBottomRight(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QPointF position = p;
...
//static QoreNode *QRECTF_moveCenter(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QPointF position = p;
...
static QoreNode *QRECTF_moveLeft(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float x = p ? p->getAsFloat() : 0;
   qrf->moveLeft(x);
...
static QoreNode *QRECTF_moveRight(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float x = p ? p->getAsFloat() : 0;
   qrf->moveRight(x);
...
static QoreNode *QRECTF_moveTo(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float x = p ? p->getAsFloat() : 0;
   p = get_param(params, 1);
...
static QoreNode *QRECTF_moveTop(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float y = p ? p->getAsFloat() : 0;
   qrf->moveTop(y);
...
//static QoreNode *QRECTF_moveTopLeft(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QPointF position = p;
...
//static QoreNode *QRECTF_moveTopRight(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QPointF position = p;
...
static QoreNode *QRECTF_normalized(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
...
//qreal right () const
static QoreNode *QRECTF_right(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qrf->right());
}

//void setBottom ( qreal y )
static QoreNode *QRECTF_setBottom(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float y = p ? p->getAsFloat() : 0;
   qrf->setBottom(y);
...
//static QoreNode *QRECTF_setBottomLeft(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QPointF position = p;
...
//static QoreNode *QRECTF_setBottomRight(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QPointF position = p;
...
static QoreNode *QRECTF_setCoords(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QRECTF_setHeight(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QRECTF_setLeft(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float x = p ? p->getAsFloat() : 0;
   qrf->setLeft(x);
...
static QoreNode *QRECTF_setRect(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float x = p ? p->getAsFloat() : 0;
   p = get_param(params, 1);
...
static QoreNode *QRECTF_setRight(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float x = p ? p->getAsFloat() : 0;
   qrf->setRight(x);
...
//static QoreNode *QRECTF_setSize(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QSizeF size = p;
//   qrf->setSize(size);
...
//void setTop ( qreal y )
static QoreNode *QRECTF_setTop(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float y = p ? p->getAsFloat() : 0;
   qrf->setTop(y);
...
//static QoreNode *QRECTF_setTopLeft(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QPointF position = p;
...
//static QoreNode *QRECTF_setTopRight(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QPointF position = p;
...
static QoreNode *QRECTF_setWidth(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float width = p ? p->getAsFloat() : 0;
   qrf->setWidth(width);
...
//void setX ( qreal x )
static QoreNode *QRECTF_setX(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float x = p ? p->getAsFloat() : 0;
   qrf->setX(x);
...
//void setY ( qreal y )
static QoreNode *QRECTF_setY(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float y = p ? p->getAsFloat() : 0;
   qrf->setY(y);
...
//QSizeF size () const
//static QoreNode *QRECTF_size(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreNode((int64)qrf->size());
//}

//QRect toAlignedRect () const
static QoreNode *QRECTF_toAlignedRect(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
...
//QRect toRect () const
static QoreNode *QRECTF_toRect(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
...
//qreal top () const
static QoreNode *QRECTF_top(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qrf->top());
}

//QPointF topLeft () const
//static QoreNode *QRECTF_topLeft(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreNode((int64)qrf->topLeft());
//}

//QPointF topRight () const
//static QoreNode *QRECTF_topRight(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreNode((int64)qrf->topRight());
//}

//void translate ( qreal dx, qreal dy )
static QoreNode *QRECTF_translate(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QRECTF_translated(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   float dx = p ? p->getAsFloat() : 0;
   p = get_param(params, 1);
...
static QoreNode *QRECTF_united(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQRectF *rectangle = (p && p->type == NT_OBJECT) ? (QoreQRectF *)p->val.object->getReferencedPrivateData(CID_QRECTF, xsink) : 0;
   if (!p || !rectangle)
...
//qreal width () const
static QoreNode *QRECTF_width(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qrf->width());
}

//qreal x () const
static QoreNode *QRECTF_x(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qrf->x());
}

//qreal y () const
static QoreNode *QRECTF_y(Object *self, QoreQRectF *qrf, QoreNode *params, ExceptionSink *xsink)
{
