...
//QTextBlockFormat ()
static void QTEXTBLOCKFORMAT_constructor(QoreObject *self, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QTEXTBLOCKFORMAT_alignment(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qtbf->alignment());
}

//qreal bottomMargin () const
static QoreNode *QTEXTBLOCKFORMAT_bottomMargin(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((double)qtbf->bottomMargin());
}

//int indent () const
static QoreNode *QTEXTBLOCKFORMAT_indent(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qtbf->indent());
}

//bool isValid () const
static QoreNode *QTEXTBLOCKFORMAT_isValid(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode(qtbf->isValid());
}

//qreal leftMargin () const
static QoreNode *QTEXTBLOCKFORMAT_leftMargin(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((double)qtbf->leftMargin());
}

//bool nonBreakableLines () const
static QoreNode *QTEXTBLOCKFORMAT_nonBreakableLines(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode(qtbf->nonBreakableLines());
}

//PageBreakFlags pageBreakPolicy () const
static QoreNode *QTEXTBLOCKFORMAT_pageBreakPolicy(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qtbf->pageBreakPolicy());
}

//qreal rightMargin () const
static QoreNode *QTEXTBLOCKFORMAT_rightMargin(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((double)qtbf->rightMargin());
}

//void setAlignment ( Qt::Alignment alignment )
static QoreNode *QTEXTBLOCKFORMAT_setAlignment(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QTEXTBLOCKFORMAT_setBottomMargin(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTEXTBLOCKFORMAT_setIndent(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTEXTBLOCKFORMAT_setLeftMargin(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   qreal margin = p ? p->getAsFloat() : 0.0;
...
static QoreNode *QTEXTBLOCKFORMAT_setNonBreakableLines(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTEXTBLOCKFORMAT_setPageBreakPolicy(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTEXTBLOCKFORMAT_setRightMargin(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   qreal margin = p ? p->getAsFloat() : 0.0;
...
static QoreNode *QTEXTBLOCKFORMAT_setTextIndent(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTEXTBLOCKFORMAT_setTopMargin(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   qreal margin = p ? p->getAsFloat() : 0.0;
...
static QoreNode *QTEXTBLOCKFORMAT_textIndent(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((double)qtbf->textIndent());
}

//qreal topMargin () const
static QoreNode *QTEXTBLOCKFORMAT_topMargin(QoreObject *self, QoreQTextBlockFormat *qtbf, const QoreList *params, ExceptionSink *xsink)
{
