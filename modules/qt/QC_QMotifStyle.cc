...
static QoreNode *QMOTIFSTYLE_drawComplexControl(Object *self, QoreAbstractQMotifStyle *qms, QoreNode *params, ExceptionSink *xsink)
{
   ...
   qms->getQMotifStyle()->drawComplexControl(control, static_cast<QStyleOptionComplex *>(option), static_cast<QPainter *>(painter), widget ? static_cast<QWidget *>(widget->getQWidget()) : 0);
   return 0;
}
...
static QoreNode *QMOTIFSTYLE_drawControl(Object *self, QoreAbstractQMotifStyle *qms, QoreNode *params, ExceptionSink *xsink)
{
   ...
   if (*xsink)
      return 0;
   ReferenceHolder<AbstractPrivateData> widgetHolder(static_cast<AbstractPrivateData *>(widget), xsink);
   qms->getQMotifStyle()->drawControl(element, static_cast<QStyleOption *>(option), static_cast<QPainter *>(painter), widget ? static_cast<QWidget *>(widget->getQWidget()) : 0);
   return 0;
}
...
static QoreNode *QMOTIFSTYLE_drawPrimitive(Object *self, QoreAbstractQMotifStyle *qms, QoreNode *params, ExceptionSink *xsink)
{
   ...
   if (*xsink)
      return 0;
   ReferenceHolder<AbstractPrivateData> widgetHolder(static_cast<AbstractPrivateData *>(widget), xsink);
   qms->getQMotifStyle()->drawPrimitive(element, static_cast<QStyleOption *>(option), static_cast<QPainter *>(painter), widget ? static_cast<QWidget *>(widget->getQWidget()) : 0);
   return 0;
}
...
static QoreNode *QMOTIFSTYLE_generatedIconPixmap(Object *self, QoreAbstractQMotifStyle *qms, QoreNode *params, ExceptionSink *xsink)
{
   ...
   QoreQPixmap *q_qp = new QoreQPixmap(qms->getQMotifStyle()->generatedIconPixmap(iconMode, *(static_cast<QPixmap *>(pixmap)), static_cast<QStyleOption *>(option)));
...
static QoreNode *QMOTIFSTYLE_hitTestComplexControl(Object *self, QoreAbstractQMotifStyle *qms, QoreNode *params, ExceptionSink *xsink)
{
   ...
   if (*xsink)
      return 0;
   ReferenceHolder<AbstractPrivateData> widgetHolder(static_cast<AbstractPrivateData *>(widget), xsink);
   return new QoreNode((int64)qms->getQMotifStyle()->hitTestComplexControl(control, static_cast<QStyleOptionComplex *>(option), *(static_cast<QPoint *>(position)), widget ? static_cast<QWidget *>(widget->getQWidget()) : 0));
}
...
static QoreNode *QMOTIFSTYLE_pixelMetric(Object *self, QoreAbstractQMotifStyle *qms, QoreNode *params, ExceptionSink *xsink)
{
   ...
   if (*xsink)
      return 0;
   ReferenceHolder<AbstractPrivateData> widgetHolder(static_cast<AbstractPrivateData *>(widget), xsink);
   return new QoreNode((int64)qms->getQMotifStyle()->pixelMetric(metric, option ? static_cast<QStyleOption *>(option) : 0, widget ? static_cast<QWidget *>(widget->getQWidget()) : 0));
}
...
static QoreNode *QMOTIFSTYLE_sizeFromContents(Object *self, QoreAbstractQMotifStyle *qms, QoreNode *params, ExceptionSink *xsink)
{
   ...
   QoreQSize *q_qs = new QoreQSize(qms->getQMotifStyle()->sizeFromContents(type, static_cast<QStyleOption *>(option), *(static_cast<QSize *>(contentsSize)), widget ? static_cast<QWidget *>(widget->getQWidget()) : 0));
...
//   ??? QStyleHintReturn* returnData = p;
   return new QoreNode((int64)qms->getQMotifStyle()->styleHint(hint, option ? static_cast<QStyleOption *>(option) : 0, widget ? static_cast<QWidget *>(widget->getQWidget()) : 0));
}
...
static QoreNode *QMOTIFSTYLE_subControlRect(Object *self, QoreAbstractQMotifStyle *qms, QoreNode *params, ExceptionSink *xsink)
{
   ...
   QoreQRect *q_qr = new QoreQRect(qms->getQMotifStyle()->subControlRect(control, static_cast<QStyleOptionComplex *>(option), subControl, widget ? static_cast<QWidget *>(widget->getQWidget()) : 0));
...
static QoreNode *QMOTIFSTYLE_subElementRect(Object *self, QoreAbstractQMotifStyle *qms, QoreNode *params, ExceptionSink *xsink)
{
   ...
   ReferenceHolder<AbstractPrivateData> widgetHolder(static_cast<AbstractPrivateData *>(widget), xsink);
   Object *o_qr = new Object(QC_QRect, getProgram());
   QoreQRect *q_qr = new QoreQRect(qms->getQMotifStyle()->subElementRect(element, static_cast<QStyleOption *>(option), widget ? static_cast<QWidget *>(widget->getQWidget()) : 0));
   o_qr->setPrivate(CID_QRECT, q_qr);
   return new QoreNode(o_qr);
}
