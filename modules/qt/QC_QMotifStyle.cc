...
static QoreNode *QMOTIFSTYLE_setUseHighlightColors(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOTIFSTYLE_useHighlightColors(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QMOTIFSTYLE_drawComplexControl(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOTIFSTYLE_drawControl(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOTIFSTYLE_drawPrimitive(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOTIFSTYLE_generatedIconPixmap(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOTIFSTYLE_hitTestComplexControl(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QMotifStyle::ComplexControl control = (QMotifStyle::ComplexControl)(p ? p->getAsInt() : 0);
   p = get_param(params, 1);
...
static QoreNode *QMOTIFSTYLE_pixelMetric(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOTIFSTYLE_sizeFromContents(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOTIFSTYLE_styleHint(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QMOTIFSTYLE_subControlRect(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QMotifStyle::ComplexControl control = (QMotifStyle::ComplexControl)(p ? p->getAsInt() : 0);
   p = get_param(params, 1);
...
static QoreNode *QMOTIFSTYLE_subElementRect(QoreObject *self, QoreAbstractQMotifStyle *qms, const QoreListNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
