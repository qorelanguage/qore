...
DLLEXPORT extern qore_classid_t CID_QSTYLEOPTIONVIEWITEMV2;
DLLEXPORT extern class QoreClass *QC_QStyleOptionViewItemV2;

DLLEXPORT class QoreClass *initQStyleOptionViewItemV2Class(QoreClass *);
