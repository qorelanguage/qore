...
#ifndef _QORE_QT_QOREABSTRACTQTOOLBUTTON_H

#define _QORE_QT_QOREABSTRACTQTOOLBUTTON_H

#include "QoreAbstractQAbstractButton.h"

class QoreAbstractQToolButton : public QoreAbstractQAbstractButton
{
   public:
