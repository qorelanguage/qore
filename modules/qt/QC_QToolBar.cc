...
static void QTOOLBAR_constructor(QoreObject *self, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QTOOLBAR_actionAt(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTOOLBAR_addAction(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTOOLBAR_addSeparator(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   return return_qaction(qtb->qobj->addSeparator());
}

//QAction * addWidget ( QWidget * widget )
static QoreNode *QTOOLBAR_addWidget(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTOOLBAR_allowedAreas(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qtb->qobj->allowedAreas());
}

//void clear ()
static QoreNode *QTOOLBAR_clear(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   qtb->qobj->clear();
   return 0;
}
...
static QoreNode *QTOOLBAR_iconSize(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QTOOLBAR_insertSeparator(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTOOLBAR_insertWidget(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QoreQAction *before = (p && p->type == NT_OBJECT) ? (QoreQAction *)p->val.object->getReferencedPrivateData(CID_QACTION, xsink) : 0;
   if (!before) {
...
static QoreNode *QTOOLBAR_isAreaAllowed(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTOOLBAR_isFloatable(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qtb->qobj->isFloatable());
}

//bool isFloating () const
static QoreNode *QTOOLBAR_isFloating(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qtb->qobj->isFloating());
}

//bool isMovable () const
static QoreNode *QTOOLBAR_isMovable(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode(qtb->qobj->isMovable());
}

//Qt::Orientation orientation () const
static QoreNode *QTOOLBAR_orientation(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qtb->qobj->orientation());
}

//void setAllowedAreas ( Qt::ToolBarAreas areas )
static QoreNode *QTOOLBAR_setAllowedAreas(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTOOLBAR_setFloatable(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTOOLBAR_setMovable(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTOOLBAR_setOrientation(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QTOOLBAR_toggleViewAction(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   return return_qaction(qtb->qobj->toggleViewAction());
}

//Qt::ToolButtonStyle toolButtonStyle () const
static QoreNode *QTOOLBAR_toolButtonStyle(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qtb->qobj->toolButtonStyle());
}

//QWidget * widgetForAction ( QAction * action ) const
static QoreNode *QTOOLBAR_widgetForAction(QoreObject *self, QoreQToolBar *qtb, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
