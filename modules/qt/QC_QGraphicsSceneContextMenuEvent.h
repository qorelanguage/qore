/*
 QC_QGraphicsSceneContextMenuEvent.h
...
#ifndef _QORE_QT_QC_QGRAPHICSSCENECONTEXTMENUEVENT_H

#define _QORE_QT_QC_QGRAPHICSSCENECONTEXTMENUEVENT_H
...
{
   public:
      DLLLOCAL QoreQGraphicsSceneContextMenuEvent(Type type = None) : QGraphicsSceneContextMenuEvent(type)
      {
      }
};

#endif // _QORE_QT_QC_QGRAPHICSSCENECONTEXTMENUEVENT_H
