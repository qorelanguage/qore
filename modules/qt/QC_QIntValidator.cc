...
static void QINTVALIDATOR_constructor(QoreObject *self, const QoreNode *params, ExceptionSink *xsink)
{
...
//int bottom () const
static QoreNode *QINTVALIDATOR_bottom(QoreObject *self, QoreQIntValidator *qiv, const QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qiv->qobj->bottom());
}

//void setBottom ( int )
static QoreNode *QINTVALIDATOR_setBottom(QoreObject *self, QoreQIntValidator *qiv, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QINTVALIDATOR_setRange(QoreObject *self, QoreQIntValidator *qiv, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//void setTop ( int )
static QoreNode *QINTVALIDATOR_setTop(QoreObject *self, QoreQIntValidator *qiv, const QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int x = p ? p->getAsInt() : 0;
   qiv->qobj->setTop(x);
...
//int top () const
static QoreNode *QINTVALIDATOR_top(QoreObject *self, QoreQIntValidator *qiv, const QoreNode *params, ExceptionSink *xsink)
{
