...
static QoreNode *QSTYLEOPTION_setRect(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//QRect rect ( ) const
static QoreNode *QSTYLEOPTION_rect(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QSTYLEOPTION_setPalette(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QSTYLEOPTION_setFontMetrics(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QSTYLEOPTION_fontMetrics(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QSTYLEOPTION_setState(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QSTYLEOPTION_state(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qso->state);
}

//void setDirection ( Qt::LayoutDirection direction )
static QoreNode *QSTYLEOPTION_setDirection(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QSTYLEOPTION_direction(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qso->direction);
}

//void setType ( int type )
static QoreNode *QSTYLEOPTION_setType(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int type = p ? p->getAsInt() : 0;
   qso->type = type;
...
//int type ( ) const
static QoreNode *QSTYLEOPTION_type(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qso->type);
}

//void setVersion ( int version )
static QoreNode *QSTYLEOPTION_setVersion(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int version = p ? p->getAsInt() : 0;
   qso->version = version;
...
//int version ( ) const
static QoreNode *QSTYLEOPTION_version(Object *self, QoreQStyleOption *qso, QoreNode *params, ExceptionSink *xsink)
{
