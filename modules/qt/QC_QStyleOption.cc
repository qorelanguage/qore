...
static void QSTYLEOPTION_constructor(QoreObject *self, const QoreList *params, ExceptionSink *xsink)
{
...
//QRect rect ( ) const
static QoreNode *QSTYLEOPTION_rect(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QSTYLEOPTION_palette(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QSTYLEOPTION_fontMetrics(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QSTYLEOPTION_setState(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QSTYLEOPTION_state(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qso->state);
}

//void setDirection ( Qt::LayoutDirection direction )
static QoreNode *QSTYLEOPTION_setDirection(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QSTYLEOPTION_direction(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qso->direction);
}

//void setType ( int type )
static QoreNode *QSTYLEOPTION_setType(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int type = p ? p->getAsInt() : 0;
   qso->type = type;
...
//int type ( ) const
static QoreNode *QSTYLEOPTION_type(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qso->type);
}

//void setVersion ( int version )
static QoreNode *QSTYLEOPTION_setVersion(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   int version = p ? p->getAsInt() : 0;
   qso->version = version;
...
//int version ( ) const
static QoreNode *QSTYLEOPTION_version(QoreObject *self, QoreQStyleOption *qso, const QoreList *params, ExceptionSink *xsink)
{
