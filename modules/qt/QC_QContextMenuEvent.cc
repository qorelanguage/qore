...
static void QCONTEXTMENUEVENT_constructor(QoreObject *self, QoreNode *params, ExceptionSink *xsink)
{
...
static QoreNode *QCONTEXTMENUEVENT_globalPos(QoreObject *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
...
//int globalX () const
static QoreNode *QCONTEXTMENUEVENT_globalX(QoreObject *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcme->globalX());
}

//int globalY () const
static QoreNode *QCONTEXTMENUEVENT_globalY(QoreObject *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcme->globalY());
}

//const QPoint & pos () const
static QoreNode *QCONTEXTMENUEVENT_pos(QoreObject *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
   QoreObject *o_qp = new QoreObject(QC_QPoint, getProgram());
...
//Reason reason () const
static QoreNode *QCONTEXTMENUEVENT_reason(QoreObject *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcme->reason());
}

//int x () const
static QoreNode *QCONTEXTMENUEVENT_x(QoreObject *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcme->x());
}

//int y () const
static QoreNode *QCONTEXTMENUEVENT_y(QoreObject *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
