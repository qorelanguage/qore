...
static void QCONTEXTMENUEVENT_constructor(Object *self, QoreNode *params, ExceptionSink *xsink)
{
...
static void QCONTEXTMENUEVENT_copy(class Object *self, class Object *old, class QoreQContextMenuEvent *qcme, ExceptionSink *xsink)
{
   xsink->raiseException("QCONTEXTMENUEVENT-COPY-ERROR", "objects of this class cannot be copied");
}

//const QPoint & globalPos () const
static QoreNode *QCONTEXTMENUEVENT_globalPos(Object *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
...
//int globalX () const
static QoreNode *QCONTEXTMENUEVENT_globalX(Object *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcme->globalX());
}

//int globalY () const
static QoreNode *QCONTEXTMENUEVENT_globalY(Object *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcme->globalY());
}

//const QPoint & pos () const
static QoreNode *QCONTEXTMENUEVENT_pos(Object *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
   Object *o_qp = new Object(QC_QPoint, getProgram());
...
//Reason reason () const
static QoreNode *QCONTEXTMENUEVENT_reason(Object *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcme->reason());
}

//int x () const
static QoreNode *QCONTEXTMENUEVENT_x(Object *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcme->x());
}

//int y () const
static QoreNode *QCONTEXTMENUEVENT_y(Object *self, QoreQContextMenuEvent *qcme, QoreNode *params, ExceptionSink *xsink)
{
