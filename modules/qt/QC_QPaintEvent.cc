...
static void QPAINTEVENT_constructor(class QoreObject *self, const QoreList *params, ExceptionSink *xsink)
{
   QoreQPaintEvent *qr;
...
static QoreNode *QPAINTEVENT_rect(QoreObject *self, QoreQPaintEvent *qpe, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QPAINTEVENT_region(QoreObject *self, QoreQPaintEvent *qpe, const QoreList *params, ExceptionSink *xsink)
{
