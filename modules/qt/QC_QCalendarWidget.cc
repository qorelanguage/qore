...
static QoreNode *QCALENDARWIDGET_dateEditAcceptDelay(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
...
//static QoreNode *QCALENDARWIDGET_dateTextFormat(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   if (is_nothing(p)) {
...
static QoreNode *QCALENDARWIDGET_firstDayOfWeek(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcw->qobj->firstDayOfWeek());
}

//QTextCharFormat headerTextFormat () const
static QoreNode *QCALENDARWIDGET_headerTextFormat(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QCALENDARWIDGET_horizontalHeaderFormat(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcw->qobj->horizontalHeaderFormat());
}

//bool isDateEditEnabled () const
static QoreNode *QCALENDARWIDGET_isDateEditEnabled(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode(qcw->qobj->isDateEditEnabled());
}

//bool isGridVisible () const
static QoreNode *QCALENDARWIDGET_isGridVisible(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode(qcw->qobj->isGridVisible());
}

//bool isNavigationBarVisible () const
static QoreNode *QCALENDARWIDGET_isNavigationBarVisible(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode(qcw->qobj->isNavigationBarVisible());
}

//QDate maximumDate () const
static QoreNode *QCALENDARWIDGET_maximumDate(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QCALENDARWIDGET_minimumDate(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QCALENDARWIDGET_monthShown(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcw->qobj->monthShown());
}

//QDate selectedDate () const
static QoreNode *QCALENDARWIDGET_selectedDate(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QCALENDARWIDGET_selectionMode(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcw->qobj->selectionMode());
}

//void setDateEditAcceptDelay ( int delay )
static QoreNode *QCALENDARWIDGET_setDateEditAcceptDelay(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QCALENDARWIDGET_setDateEditEnabled(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QCALENDARWIDGET_setDateTextFormat(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QDate date;
   if (get_qdate(p, date, xsink))
...
static QoreNode *QCALENDARWIDGET_setFirstDayOfWeek(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QCALENDARWIDGET_setHorizontalHeaderFormat(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QCALENDARWIDGET_setMaximumDate(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QDate date;
   if (get_qdate(p, date, xsink))
...
static QoreNode *QCALENDARWIDGET_setMinimumDate(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QDate date;
   if (get_qdate(p, date, xsink))
...
static QoreNode *QCALENDARWIDGET_setSelectionMode(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QCALENDARWIDGET_setVerticalHeaderFormat(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QCALENDARWIDGET_setWeekdayTextFormat(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   Qt::DayOfWeek dayOfWeek = (Qt::DayOfWeek)(p ? p->getAsInt() : 0);
   p = get_param(params, 1);
...
static QoreNode *QCALENDARWIDGET_verticalHeaderFormat(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcw->qobj->verticalHeaderFormat());
}

//QTextCharFormat weekdayTextFormat ( Qt::DayOfWeek dayOfWeek ) const
static QoreNode *QCALENDARWIDGET_weekdayTextFormat(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   Qt::DayOfWeek dayOfWeek = (Qt::DayOfWeek)(p ? p->getAsInt() : 0);
   QoreObject *o_qtcf = new QoreObject(QC_QTextCharFormat, getProgram());
...
//int yearShown () const
static QoreNode *QCALENDARWIDGET_yearShown(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qcw->qobj->yearShown());
}

//void setCurrentPage ( int year, int month )
static QoreNode *QCALENDARWIDGET_setCurrentPage(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QCALENDARWIDGET_setDateRange(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QDate min;
...
static QoreNode *QCALENDARWIDGET_setGridVisible(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QCALENDARWIDGET_setNavigationBarVisible(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QCALENDARWIDGET_setSelectedDate(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QDate date;
   if (get_qdate(p, date, xsink))
...
//void showNextMonth ()
static QoreNode *QCALENDARWIDGET_showNextMonth(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
...
//void showNextYear ()
static QoreNode *QCALENDARWIDGET_showNextYear(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QCALENDARWIDGET_showPreviousMonth(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QCALENDARWIDGET_showPreviousYear(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QCALENDARWIDGET_showSelectedDate(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
...
//void showToday ()
static QoreNode *QCALENDARWIDGET_showToday(QoreObject *self, QoreQCalendarWidget *qcw, const QoreList *params, ExceptionSink *xsink)
{
   qcw->qobj->showToday();
   return 0;
}
