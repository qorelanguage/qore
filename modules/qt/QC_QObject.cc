...
static void QOBJECT_constructor(class QoreObject *self, const QoreList *params, ExceptionSink *xsink)
{
   QoreQObject *qo;
...
static QoreNode *QOBJECT_blockSignals(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
...
//static QoreNode *QOBJECT_children(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
//{
...
static QoreNode *QOBJECT_connect(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QOBJECT_disconnect(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   int offset = 0;
...
//void dumpObjectInfo ()
static QoreNode *QOBJECT_dumpObjectInfo(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
...
//void dumpObjectTree ()
static QoreNode *QOBJECT_dumpObjectTree(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
...
//static QoreNode *QOBJECT_dynamicPropertyNames(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
//{
//   ??? return new QoreNode((int64)qo->getQObject()->dynamicPropertyNames());
//}

//virtual bool event ( QEvent * e )
//static QoreNode *QOBJECT_event(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   ??? QEvent* e = p;
...
//static QoreNode *QOBJECT_eventFilter(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
...
//static QoreNode *QOBJECT_findChild(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
...
//static QoreNode *QOBJECT_findChildren(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
//   if (!p || p->type != NT_STRING) {
...
static QoreNode *QOBJECT_inherits(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QOBJECT_installEventFilter(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QOBJECT_isWidgetType(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode(qo->getQObject()->isWidgetType());
}

//void killTimer ( int id )
static QoreNode *QOBJECT_killTimer(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QOBJECT_metaObject(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
...
//static QoreNode *QOBJECT_moveToThread(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
//{
//   QoreNode *p = get_param(params, 0);
...
static QoreNode *QOBJECT_objectName(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreStringNode(qo->getQObject()->objectName().toUtf8().data(), QCS_UTF8);
}

//QObject * parent () const
static QoreNode *QOBJECT_parent(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QOBJECT_property(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p) {
...
static QoreNode *QOBJECT_removeEventFilter(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QOBJECT_setObjectName(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QString name;
...
static QoreNode *QOBJECT_setParent(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QOBJECT_setProperty(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QOBJECT_signalsBlocked(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode(qo->getQObject()->signalsBlocked());
}

//int startTimer ( int interval )
static QoreNode *QOBJECT_startTimer(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//static QoreNode *QOBJECT_thread(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
//{
//   ??? return qo->getQObject()->thread();
//}

// custom methods
static QoreNode *QOBJECT_createSignal(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p) {
...
static QoreNode *QOBJECT_emit(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreStringNode *p = test_string_param(params, 0);
   if (!p) {
...
static QoreNode *QOBJECT_sender(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QOBJECT_childEvent(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QOBJECT_timerEvent(QoreObject *self, QoreAbstractQObject *qo, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
