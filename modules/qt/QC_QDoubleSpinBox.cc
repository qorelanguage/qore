...
static void QDOUBLESPINBOX_constructor(QoreObject *self, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *QDOUBLESPINBOX_cleanText(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreStringNode(qdsb->qobj->cleanText().toUtf8().data(), QCS_UTF8);
}

//int decimals () const
static QoreNode *QDOUBLESPINBOX_decimals(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((int64)qdsb->qobj->decimals());
}

//double maximum () const
static QoreNode *QDOUBLESPINBOX_maximum(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((double)qdsb->qobj->maximum());
}

//double minimum () const
static QoreNode *QDOUBLESPINBOX_minimum(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((double)qdsb->qobj->minimum());
}

//QString prefix () const
static QoreNode *QDOUBLESPINBOX_prefix(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreStringNode(qdsb->qobj->prefix().toUtf8().data(), QCS_UTF8);
}

//void setDecimals ( int prec )
static QoreNode *QDOUBLESPINBOX_setDecimals(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QDOUBLESPINBOX_setMaximum(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QDOUBLESPINBOX_setMinimum(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QDOUBLESPINBOX_setPrefix(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QString prefix;
...
static QoreNode *QDOUBLESPINBOX_setRange(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QDOUBLESPINBOX_setSingleStep(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
static QoreNode *QDOUBLESPINBOX_setSuffix(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QString suffix;
...
static QoreNode *QDOUBLESPINBOX_singleStep(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((double)qdsb->qobj->singleStep());
}

//QString suffix () const
static QoreNode *QDOUBLESPINBOX_suffix(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreStringNode(qdsb->qobj->suffix().toUtf8().data(), QCS_UTF8);
}

//virtual QString textFromValue ( double value ) const
static QoreNode *QDOUBLESPINBOX_textFromValue(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
...
//double value () const
static QoreNode *QDOUBLESPINBOX_value(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   return new QoreNode((double)qdsb->qobj->value());
}

//virtual double valueFromText ( const QString & text ) const
static QoreNode *QDOUBLESPINBOX_valueFromText(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   QString text;
...
static QoreNode *QDOUBLESPINBOX_setValue(QoreObject *self, QoreQDoubleSpinBox *qdsb, const QoreList *params, ExceptionSink *xsink)
{
   QoreNode *p = get_param(params, 0);
   double val = p ? p->getAsFloat() : 0.0;
