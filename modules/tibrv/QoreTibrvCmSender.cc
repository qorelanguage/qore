...
void QoreTibrvCmSender::sendSubject(const char *subject, const QoreHashNode *data, const char *replySubject, int64 time_limit, class ExceptionSink *xsink)
{
   TibrvMsg msg;
...
QoreHashNode *QoreTibrvCmSender::sendSubjectWithSyncReply(const char *subject, const QoreHashNode *data, int64 timeout, int64 time_limit, class ExceptionSink *xsink)
{
   TibrvMsg msg;
