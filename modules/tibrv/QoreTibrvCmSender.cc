...
void QoreTibrvCmSender::sendSubject(const char *subject, const QoreHash *data, const char *replySubject, int64 time_limit, class ExceptionSink *xsink)
{
   TibrvMsg msg;
...
QoreHashNode *QoreTibrvCmSender::sendSubjectWithSyncReply(const char *subject, const QoreHash *data, int64 timeout, int64 time_limit, class ExceptionSink *xsink)
{
   TibrvMsg msg;
