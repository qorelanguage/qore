...
void TIBRVDQ_constructor(class QoreObject *self, const QoreList *params, class ExceptionSink *xsink)
{
...
class QoreNode *TIBRVDQ_setWorkerWeight(class QoreObject *self, class QoreTibrvDistributedQueue *dq, const QoreList *params, ExceptionSink *xsink)
{
...
class QoreNode *TIBRVDQ_setWorkerTasks(class QoreObject *self, class QoreTibrvDistributedQueue *dq, const QoreList *params, ExceptionSink *xsink)
{
   class QoreNode *pt = get_param(params, 0);
...
class QoreNode *TIBRVDQ_getWorkerWeight(class QoreObject *self, class QoreTibrvDistributedQueue *dq, const QoreList *params, ExceptionSink *xsink)
{
...
class QoreNode *TIBRVDQ_getWorkerTasks(class QoreObject *self, class QoreTibrvDistributedQueue *dq, const QoreList *params, ExceptionSink *xsink)
{
