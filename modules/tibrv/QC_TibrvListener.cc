...
void TIBRVLISTENER_constructor(class QoreObject *self, const QoreList *params, class ExceptionSink *xsink)
{
...
static QoreNode *TIBRVLISTENER_getQueueSize(class QoreObject *self, class QoreTibrvListener *trvl, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *TIBRVLISTENER_getMessage(class QoreObject *self, class QoreTibrvListener *trvl, const QoreList *params, ExceptionSink *xsink)
{
...
static QoreNode *TIBRVLISTENER_createInboxName(class QoreObject *self, class QoreTibrvListener *trvl, const QoreList *params, ExceptionSink *xsink)
{
   return trvl->createInboxName(xsink);
}

class QoreNode *TIBRVLISTENER_setStringEncoding(class QoreObject *self, class QoreTibrvListener *trvl, const QoreList *params, ExceptionSink *xsink)
{
...
class QoreNode *TIBRVLISTENER_getStringEncoding(class QoreObject *self, class QoreTibrvListener *trvl, const QoreList *params, ExceptionSink *xsink)
{
