...
QoreHashNode *QoreTibrvListener::getMessage(class ExceptionSink *xsink)
{
   QoreHashNode *h;
...
QoreHashNode *QoreTibrvListener::getMessage(int64 timeout_ms, class ExceptionSink *xsink)
{
