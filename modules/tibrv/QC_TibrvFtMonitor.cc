...
static void TIBRVFTMONITOR_constructor(class QoreObject *self, const QoreList *params, class ExceptionSink *xsink)
{
...
static QoreNode *TIBRVFTMONITOR_getEvent(class QoreObject *self, class QoreTibrvFtMonitor *ftm, const QoreList *params, ExceptionSink *xsink)
{
   return ftm->getEvent(xsink);
}

static QoreNode *TIBRVFTMONITOR_stop(class QoreObject *self, class QoreTibrvFtMonitor *ftm, const QoreList *params, ExceptionSink *xsink)
{
   ftm->stop();
   return NULL;
}

class QoreNode *TIBRVFTMONITOR_getGroupName(class QoreObject *self, class QoreTibrvFtMonitor *ftm, const QoreList *params, ExceptionSink *xsink)
{
