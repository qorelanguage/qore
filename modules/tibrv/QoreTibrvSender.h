...
class QoreTibrvSender : public AbstractPrivateData, public QoreTibrvTransport
{
   ...
   public:
      ...
      void sendSubject(const char *subject, const QoreHashNode *data, const char *replySubject, class ExceptionSink *xsink);
      
      // timout in ms
      QoreHashNode *sendSubjectWithSyncReply(const char *subject, const QoreHashNode *data, int64 timeout, class ExceptionSink *xsink);
};
