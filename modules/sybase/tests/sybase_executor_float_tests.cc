...
TEST()
{
  ...
  sybase_executor executor;
  executor.m_parsed_query.m_result_query_text = "insert into float_table values (?)";
  executor.m_parsed_query.m_is_procedure = false;
  ...
  executor.m_parsed_query.m_result_query_text = "insert into float_table values (1.2)";
  ...
  executor.m_parsed_query.m_result_query_text = "select count(*) from float_table";
  ...
  executor.m_parsed_query.m_result_query_text = "select * from float_table";
  ...
  executor.m_parsed_query.m_result_query_text = "delete from float_table";
  executor.m_args = new List;
  n = executor.exec(&xsink);
  if (xsink.isException()) {
    assert(false);
