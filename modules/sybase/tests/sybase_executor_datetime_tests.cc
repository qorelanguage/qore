...
TEST()
{
  ...
  sybase_executor executor;
  executor.m_parsed_query.m_result_query_text = "insert into datetime_table values (?)";
  executor.m_parsed_query.m_is_procedure = false;
  ...
  executor.m_parsed_query.m_result_query_text = "select count(*) from datetime_table";
  ...
  executor.m_parsed_query.m_result_query_text = "select * from datetime_table";
  ...
  executor.m_parsed_query.m_result_query_text = "delete from datetime_table";
  executor.m_args = new List;
