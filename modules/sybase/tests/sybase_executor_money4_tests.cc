...
TEST()
{
  ...
  executor.m_parsed_query.m_result_dynamic_query_text = "select * from money4_table where money4_col = ?";
...
TEST()
{
  ...
  sybase_executor executor;
  executor.m_parsed_query.m_result_dynamic_query_text = "insert into money4_table values (?)";
  executor.m_parsed_query.m_is_procedure = false;
  ...
  executor.m_parsed_query.m_result_dynamic_query_text = "select count(*) from money4_table";
  ...
  executor.m_parsed_query.m_result_dynamic_query_text = "select * from money4_table";
  ...
  executor.m_parsed_query.m_result_dynamic_query_text = "delete from money4_table";
