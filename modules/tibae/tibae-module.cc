...
char qore_module_name[] = "tibae";
char qore_module_version[] = "0.2";
char qore_module_description[] = "TIBCO Active Enterprise module";
...
qore_module_init_t qore_module_init = tibae_module_init;
qore_module_ns_init_t qore_module_ns_init = tibae_module_ns_init;
qore_module_delete_t qore_module_delete = tibae_module_delete;
#endif
