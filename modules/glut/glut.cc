...
static QoreStringNode *glut_module_init()
{
   ...
   builtinFunctions.add("glutInitDisplayString",        f_glutInitDisplayString);
   builtinFunctions.add("glutCreateSubWindow",          f_glutCreateSubWindow);
   builtinFunctions.add("glutDestroyWindow",            f_glutDestroyWindow);
   builtinFunctions.add("glutGetWindow",                f_glutGetWindow);
   builtinFunctions.add("glutSetWindow",                f_glutSetWindow);
   builtinFunctions.add("glutSetWindowTitle",           f_glutSetWindowTitle);
   builtinFunctions.add("glutSetIconTitle",             f_glutSetIconTitle);
   builtinFunctions.add("glutPositionWindow",           f_glutPositionWindow);
   builtinFunctions.add("glutReshapeWindow",            f_glutReshapeWindow);
   builtinFunctions.add("glutPopWindow",                f_glutPopWindow);
   builtinFunctions.add("glutPushWindow",               f_glutPushWindow);
   builtinFunctions.add("glutIconifyWindow",            f_glutIconifyWindow);
   builtinFunctions.add("glutShowWindow",               f_glutShowWindow);
   builtinFunctions.add("glutHideWindow",               f_glutHideWindow);
   ...
   builtinFunctions.add("glutPostOverlayRedisplay",     f_glutPostOverlayRedisplay);
   builtinFunctions.add("glutPostWindowOverlayRedisplay", f_glutPostWindowOverlayRedisplay);
   builtinFunctions.add("glutShowOverlay",              f_glutShowOverlay);
   builtinFunctions.add("glutHideOverlay",              f_glutHideOverlay);
   builtinFunctions.add("glutCreateMenu",               f_glutCreateMenu);
   builtinFunctions.add("glutDestroyMenu",              f_glutDestroyMenu);
   builtinFunctions.add("glutGetMenu",                  f_glutGetMenu);
   builtinFunctions.add("glutSetMenu",                  f_glutSetMenu);
   builtinFunctions.add("glutAddMenuEntry",             f_glutAddMenuEntry);
   builtinFunctions.add("glutAddSubMenu",               f_glutAddSubMenu);
   builtinFunctions.add("glutChangeToMenuEntry",        f_glutChangeToMenuEntry);
   builtinFunctions.add("glutChangeToSubMenu",          f_glutChangeToSubMenu);
   builtinFunctions.add("glutRemoveMenuItem",           f_glutRemoveMenuItem);
   builtinFunctions.add("glutAttachMenu",               f_glutAttachMenu);
   builtinFunctions.add("glutDetachMenu",               f_glutDetachMenu);
   builtinFunctions.add("glutDisplayFunc",              f_glutDisplayFunc);
   builtinFunctions.add("glutReshapeFunc",              f_glutReshapeFunc);
   builtinFunctions.add("glutKeyboardFunc",             f_glutKeyboardFunc);
   builtinFunctions.add("glutMouseFunc",                f_glutMouseFunc);
   builtinFunctions.add("glutMotionFunc",               f_glutMotionFunc);
   builtinFunctions.add("glutPassiveMotionFunc",        f_glutPassiveMotionFunc);
   builtinFunctions.add("glutEntryFunc",                f_glutEntryFunc);
   builtinFunctions.add("glutVisibilityFunc",           f_glutVisibilityFunc);
   builtinFunctions.add("glutIdleFunc",                 f_glutIdleFunc);
   builtinFunctions.add("glutTimerFunc",                f_glutTimerFunc);
   builtinFunctions.add("glutMenuStateFunc",            f_glutMenuStateFunc);
   builtinFunctions.add("glutSpecialFunc",              f_glutSpecialFunc);
   builtinFunctions.add("glutSpaceballMotionFunc",      f_glutSpaceballMotionFunc);
   builtinFunctions.add("glutSpaceballRotateFunc",      f_glutSpaceballRotateFunc);
   builtinFunctions.add("glutSpaceballButtonFunc",      f_glutSpaceballButtonFunc);
   builtinFunctions.add("glutButtonBoxFunc",            f_glutButtonBoxFunc);
   builtinFunctions.add("glutDialsFunc",                f_glutDialsFunc);
   builtinFunctions.add("glutTabletMotionFunc",         f_glutTabletMotionFunc);
   builtinFunctions.add("glutTabletButtonFunc",         f_glutTabletButtonFunc);
   builtinFunctions.add("glutMenuStatusFunc",           f_glutMenuStatusFunc);
   builtinFunctions.add("glutOverlayDisplayFunc",       f_glutOverlayDisplayFunc);
   builtinFunctions.add("glutWindowStatusFunc",         f_glutWindowStatusFunc);
   builtinFunctions.add("glutKeyboardUpFunc",           f_glutKeyboardUpFunc);
   builtinFunctions.add("glutSpecialUpFunc",            f_glutSpecialUpFunc);
   builtinFunctions.add("glutJoystickFunc",             f_glutJoystickFunc);
   builtinFunctions.add("glutSetColor",                 f_glutSetColor);
   builtinFunctions.add("glutGetColor",                 f_glutGetColor);
   builtinFunctions.add("glutCopyColormap",             f_glutCopyColormap);
   builtinFunctions.add("glutDeviceGet",                f_glutDeviceGet);
   ...
   builtinFunctions.add("glutStrokeWidth",              f_glutStrokeWidth);
   builtinFunctions.add("glutBitmapLength",             f_glutBitmapLength);
   builtinFunctions.add("glutStrokeLength",             f_glutStrokeLength);
   builtinFunctions.add("glutWireSphere",               f_glutWireSphere);
   builtinFunctions.add("glutSolidSphere",              f_glutSolidSphere);
   builtinFunctions.add("glutWireCone",                 f_glutWireCone);
   builtinFunctions.add("glutSolidCone",                f_glutSolidCone);
   builtinFunctions.add("glutWireCube",                 f_glutWireCube);
   builtinFunctions.add("glutSolidCube",                f_glutSolidCube);
   builtinFunctions.add("glutWireTorus",                f_glutWireTorus);
   builtinFunctions.add("glutSolidTorus",               f_glutSolidTorus);
   builtinFunctions.add("glutWireDodecahedron",         f_glutWireDodecahedron);
   builtinFunctions.add("glutSolidDodecahedron",        f_glutSolidDodecahedron);
   builtinFunctions.add("glutWireTeapot",               f_glutWireTeapot);
   builtinFunctions.add("glutSolidTeapot",              f_glutSolidTeapot);
   builtinFunctions.add("glutWireOctahedron",           f_glutWireOctahedron);
   builtinFunctions.add("glutSolidOctahedron",          f_glutSolidOctahedron);
   builtinFunctions.add("glutWireTetrahedron",          f_glutWireTetrahedron);
   builtinFunctions.add("glutSolidTetrahedron",         f_glutSolidTetrahedron);
   builtinFunctions.add("glutWireIcosahedron",          f_glutWireIcosahedron);
   builtinFunctions.add("glutSolidIcosahedron",         f_glutSolidIcosahedron);
   builtinFunctions.add("glutVideoResizeGet",           f_glutVideoResizeGet);
   builtinFunctions.add("glutSetupVideoResizing",       f_glutSetupVideoResizing);
   builtinFunctions.add("glutStopVideoResizing",        f_glutStopVideoResizing);
   builtinFunctions.add("glutVideoResize",              f_glutVideoResize);
   builtinFunctions.add("glutVideoPan",                 f_glutVideoPan);
   builtinFunctions.add("glutReportErrors",             f_glutReportErrors);
   builtinFunctions.add("glutIgnoreKeyRepeat",          f_glutIgnoreKeyRepeat);
   builtinFunctions.add("glutSetKeyRepeat",             f_glutSetKeyRepeat);
   builtinFunctions.add("glutForceJoystickFunc",        f_glutForceJoystickFunc);
   builtinFunctions.add("glutGameModeString",           f_glutGameModeString);
   builtinFunctions.add("glutEnterGameMode",            f_glutEnterGameMode);
   builtinFunctions.add("glutLeaveGameMode",            f_glutLeaveGameMode);
   builtinFunctions.add("glutGameModeGet",              f_glutGameModeGet);
