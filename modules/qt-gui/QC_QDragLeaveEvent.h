...
DLLEXPORT extern qore_classid_t CID_QDRAGLEAVEEVENT;
DLLEXPORT extern class QoreClass *QC_QDragLeaveEvent;

DLLEXPORT class QoreClass *initQDragLeaveEventClass(QoreClass *);
