...
QoreClass *initQFontDialogClass()
{
   QoreClass *QC_QFontDialog = new QoreClass("QFontDialog", QDOM_GUI);

   QC_QFontDialog->addStaticMethod("getFont",  f_QFontDialog_getFont);

   return QC_QFontDialog;
}
