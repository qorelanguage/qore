...
DLLEXPORT extern qore_classid_t CID_QDESKTOPWIDGET;
DLLEXPORT extern class QoreClass *QC_QDesktopWidget;

DLLEXPORT class QoreClass *initQDesktopWidgetClass(QoreClass *);
