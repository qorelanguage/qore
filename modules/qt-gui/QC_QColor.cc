...
//int alpha () const
static AbstractQoreNode *QCOLOR_alpha(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->alpha());
}

//qreal alphaF () const
static AbstractQoreNode *QCOLOR_alphaF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreFloatNode(qc->alphaF());
}

//int black () const
static AbstractQoreNode *QCOLOR_black(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->black());
}

//qreal blackF () const
static AbstractQoreNode *QCOLOR_blackF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreFloatNode(qc->blackF());
}

//int blue () const
static AbstractQoreNode *QCOLOR_blue(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->blue());
}

//qreal blueF () const
static AbstractQoreNode *QCOLOR_blueF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
...
//int cyan () const
static AbstractQoreNode *QCOLOR_cyan(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->cyan());
}

//qreal cyanF () const
static AbstractQoreNode *QCOLOR_cyanF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
...
//int green () const
static AbstractQoreNode *QCOLOR_green(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->green());
}

//qreal greenF () const
static AbstractQoreNode *QCOLOR_greenF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreFloatNode(qc->greenF());
}

//int hue () const
static AbstractQoreNode *QCOLOR_hue(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->hue());
}

//qreal hueF () const
static AbstractQoreNode *QCOLOR_hueF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
...
//int magenta () const
static AbstractQoreNode *QCOLOR_magenta(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->magenta());
}

//qreal magentaF () const
static AbstractQoreNode *QCOLOR_magentaF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreFloatNode(qc->magentaF());
}

//QString name () const
static AbstractQoreNode *QCOLOR_name(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreStringNode(qc->name().toUtf8().data(), QCS_UTF8);
}

//int red () const
static AbstractQoreNode *QCOLOR_red(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->red());
}

//qreal redF () const
static AbstractQoreNode *QCOLOR_redF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreFloatNode(qc->redF());
}

//QRgb rgb () const
static AbstractQoreNode *QCOLOR_rgb(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->rgb());
}

//QRgb rgba () const
static AbstractQoreNode *QCOLOR_rgba(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->rgba());
}

//int saturation () const
static AbstractQoreNode *QCOLOR_saturation(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->saturation());
}

//qreal saturationF () const
static AbstractQoreNode *QCOLOR_saturationF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
...
//Spec spec () const
//static AbstractQoreNode *QCOLOR_spec(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreBigIntNode(qc->spec());
//}

//QColor toCmyk () const
//static AbstractQoreNode *QCOLOR_toCmyk(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreBigIntNode(qc->toCmyk());
//}

//QColor toHsv () const
//static AbstractQoreNode *QCOLOR_toHsv(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreBigIntNode(qc->toHsv());
//}

//QColor toRgb () const
//static AbstractQoreNode *QCOLOR_toRgb(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
//{
//   ??? return new QoreBigIntNode(qc->toRgb());
//}

//int value () const
static AbstractQoreNode *QCOLOR_value(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->value());
}

//qreal valueF () const
static AbstractQoreNode *QCOLOR_valueF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreFloatNode(qc->valueF());
}

//int yellow () const
static AbstractQoreNode *QCOLOR_yellow(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qc->yellow());
}

//qreal yellowF () const
static AbstractQoreNode *QCOLOR_yellowF(QoreObject *self, QoreQColor *qc, const QoreListNode *params, ExceptionSink *xsink)
{
...
static AbstractQoreNode *f_QColor_colorNames(const QoreListNode *params, ExceptionSink *xsink)
{
