...
DLLEXPORT extern qore_classid_t CID_QABSTRACTSCROLLAREA;
DLLEXPORT extern class QoreClass *QC_QAbstractScrollArea;

DLLEXPORT class QoreClass *initQAbstractScrollAreaClass(QoreClass *);
