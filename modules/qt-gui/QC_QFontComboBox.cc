...
static AbstractQoreNode *QFONTCOMBOBOX_currentFont(QoreObject *self, QoreQFontComboBox *qfcb, const QoreListNode *params, ExceptionSink *xsink)
{
...
static AbstractQoreNode *QFONTCOMBOBOX_fontFilters(QoreObject *self, QoreQFontComboBox *qfcb, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qfcb->qobj->fontFilters());
}
...
static AbstractQoreNode *QFONTCOMBOBOX_writingSystem(QoreObject *self, QoreQFontComboBox *qfcb, const QoreListNode *params, ExceptionSink *xsink)
{
   return new QoreBigIntNode(qfcb->qobj->writingSystem());
}
