...
DLLEXPORT extern qore_classid_t CID_QWINDOWSSTYLE;
DLLEXPORT extern class QoreClass *QC_QWindowsStyle;

DLLEXPORT class QoreClass *initQWindowsStyleClass(QoreClass *);
