...
%files oracle-module
%ifarch i386
/usr/lib/qore-0.6.1.2/auto/oracle.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.6.1.2/auto/oracle.qmod
%endif
...
%files mysql-module
%ifarch i386
/usr/lib/qore-0.6.1.2/auto/mysql.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.6.1.2/auto/mysql.qmod
%endif
...
%files tibae-module
/usr/lib/qore-0.6.1.2/tibae.qmod
%endif
...
%files tibrv-module
%ifarch i386
/usr/lib/qore-0.6.1.2/tibrv.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.6.1.2/tibrv.qmod
%endif
...
%files tuxedo-module
%ifarch i386
/usr/lib/qore-0.6.1.2/tuxedo.qmod
%endif
%ifarch x86_64
/usr/lib64/qore-0.6.1.2/tuxedo.qmod
%endif
...
%ifarch i386
mkdir -p $RPM_BUILD_ROOT/usr/lib/qore-0.6.1.2
mkdir -p $RPM_BUILD_ROOT/usr/lib/qore-0.6.1.2/auto
%endif
%ifarch x86_64
mkdir -p $RPM_BUILD_ROOT/usr/lib64/qore-0.6.1.2
mkdir -p $RPM_BUILD_ROOT/usr/lib64/qore-0.6.1.2/auto
%endif
...
/usr/bin/qore
%ifarch i386
/usr/lib/libqore.so.1.1.1
/usr/lib/libqore.so.1
/usr/lib/libqore.so
/usr/lib/libqore.la
/usr/lib/qore-0.6.1.2/ncurses.qmod
%endif
%ifarch x86_64
/usr/lib64/libqore.so.1.1.1
/usr/lib64/libqore.so.1
/usr/lib64/libqore.so
/usr/lib64/libqore.la
/usr/lib64/qore-0.6.1.2/ncurses.qmod
%endif
/usr/man/man1/qore.1.gz

%changelog
* Tue Mar 27 2007 David Nichols <david_nichols@users.sourceforge.net>
- updated to 0.6.1.2

* Mon Feb 19 2007 David Nichols <david_nichols@users.sourceforge.net>
- updated to 0.6.1.1 and libqore 1.1.1

* Tue Feb 11 2007 David Nichols <david_nichols@users.sourceforge.net>
- updated to 0.6.1 and libqore 1.1
